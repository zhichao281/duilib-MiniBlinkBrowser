...
void CBrowserTabUI::DoInit()
{
	...
	m_pOption->ApplyAttributeList(_T(" float=\"true\" ")\
		_T("group=\"group1\" text=\"新标签页\" name=\"browseroption\" pos=\"0,0,174,32\" endellipsis=\"true\" textpadding=\"50,0,50,0\"  text=\"新标签页\" maxwidth=\"174\" height=\"30\" normalimage=\"file=\'imgs/tabitem.png\' dest = \'0,0,174,32\' source=\'0,0,174,32\'\" hotimage=\"file=\'imgs/tabitem.png\' source=\'174,0,348,32\'\" pushedimage=\"file=\'imgs/tabitem.png\' source=\'348,0,522,32\'\" selectedimage=\"file=\'imgs/tabitem.png\' source=\'348,0,522,32\'\" align=\"center\" "));
	...
	m_pIcon->ApplyAttributeList(_T("float=\"true\" pos=\"20,8,40,28\" mouse=\"false\" normalimage=\"file = \'imgs/logo.png\' dest = \'0,0,20,20\' \""));
...
void CBrowserTabUI::SetTabImage(LPCTSTR pStrImage)
{
	TCHAR szImage[512];
	swprintf_s(szImage, _T("file = \'%s\'"), pStrImage);
	m_pIcon->SetAttribute(L"normalimage", szImage);
}
