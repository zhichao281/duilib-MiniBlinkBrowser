...
!function(e) {
    ...
    function i(e, t) {
        ...
        a.length > 0)
            throw new Error("[REQUIRE_FATAL]Relative ID is not allowed in global require: " + a.join(", "));
        var o = N.waitSeconds;
        return o && e instanceof Array && (E && clearTimeout(E),
        E = setTimeout(n, 1e3 * o)),
        D(e, t)
    }
    function n() {
        function e(r, s) {
        ...
        if (t.length || i.length)
            throw new Error("[MODULE_TIMEOUT]Hang( " + (t.join(", ") || "none") + " ) Miss( " + (i.join(", ") || "none") + " )")
    }
    function a(e) {
        C(B, function(t) {
    ...
    function l(e) {
        ...
        if (t && !m(e, M)) {
            var i = t.deps
              , n = t.factory
              , a = 0;
            "function" == typeof n && (a = Math.min(n.length, i.length),
            !t.depsDec && n.toString().replace(/(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm, "").replace(/require\(\s*(['"'])([^'"]+)\1\s*\)/g, function(e, t, n) {
                i.push(n)
            }));
            var o = []
              , r = [];
            C(i, function(i, n) {
                var s, l, h = W(i), d = L(h.mod, e);
                d && !P[d] ? (h.res && (l = {
                    id: i,
                    mod: d,
                    res: h.res
    ...
    function f(t) {
        ...
        function n() {
            if (r) {
                ...
                null == i && r.exports && (i = e,
                C(r.exports.split("."), function(e) {
                    return i = i[e],
                    !!i
                })),
                o(t, s, i || {})
    ...
    function _() {
        ...
        q = b(N.urlArgs, 1),
        Q = {};
        for (var t in N.bundles)
            C(N.bundles[t], e)
    }
    function x(e, t, i) {
        C(t, function(t) {
            return t.reg.test(e) ? (i(t.v, t.k, t),
            !1) : void 0
        })
    }
    function k(e) {
        ...
        if (!r) {
        	x(a, Y, function(e, t, i) {
	            s = s.replace(i.name, i.location)
		    });
	    };
        
        var bTest = /^([a-z]{2,10}:\/)?\//i.test(s);
    	if (!bTest)
    		s = N.baseUrl + s
        ...
        function i(i, a) {
            if ("string" == typeof i) {
                if (!n[i]) {
                    ...
                    if (p(o),
                    !m(o, J))
                        throw new Error('[MODULE_MISS]"' + o + '" is not exists!');
                    n[i] = z[o].exports
                }
                return n[i]
            }
    ...
    function S(e, t) {
        function i() {
            var e = n.readyState;
            ("undefined" == typeof e || /^(loaded|complete)$/.test(e)) && (n.onload = n.onreadystatechange = null,
            n = null,
            t())
        }
    ...
    ,
    _();
    var G, Y, Z, Q, q, j, $, ee = document.getElementsByTagName("head")[0], te = document.getElementsByTagName("base")[0];
    te && (ee = te.parentNode),
    define || (define = o,
    require || (require = i),
    esl = i)
...
define("echarts/echarts", ["require", "./config", "zrender/tool/util", "zrender/tool/event", "zrender/tool/env", "zrender", "zrender/config", "./chart/island", "./component/toolbox", "./component", "./component/title", "./component/tooltip", "./component/legend", "./util/ecData", "./chart", "zrender/tool/color", "./component/timeline", "zrender/shape/Image", "zrender/loadingEffect/Bar", "zrender/loadingEffect/Bubble", "zrender/loadingEffect/DynamicLine", "zrender/loadingEffect/Ring", "zrender/loadingEffect/Spin", "zrender/loadingEffect/Whirling", "./theme/macarons", "./theme/infographic"], function(e) {
    ...
    return i.prototype = {
        _init: function() {
            ...
            ;
            for (var n in a.EVENT)
                "CLICK" != n && "DBLCLICK" != n && "HOVER" != n && "MOUSEOUT" != n && "MAP_ROAM" != n && this._messageCenter.bind(a.EVENT[n], this._onevent, this);
            var o = {};
            ...
            this._island = new d(this._themeConfig,this._messageCenter,i,{},this),
            this.chart.island = this._island;
            var c = e("./component/toolbox");
            this._toolbox = new c(this._themeConfig,this._messageCenter,i,{},this),
        ...
        __onevent: function(e) {
            ...
            switch (this._curEventType || (this._curEventType = e.type),
            e.type) {
            ...
            case a.EVENT.TOOLTIP_OUT_GRID:
                if (t) {
                    if (this._connected) {
                        ...
                        o && (e.x = (e.event.zrenderX - o.getX()) / o.getWidth(),
            ...
            if (this._connected && t && this._curEventType === e.type) {
                for (var r in this._connected)
                    this._connected[r].connectedEventHandler(e);
        ...
        _ondragend: function(e) {
            if (n(this, "ondragend", e, this._status),
        ...
        _noDataCheck: function(e) {
            for (var t = e.series, i = 0, n = t.length; n > i; i++)
                if (t[i].type == a.CHART_TYPE_MAP || t[i].data && t[i].data.length > 0 || t[i].markPoint && t[i].markPoint.data && t[i].markPoint.data.length > 0 || t[i].markLine && t[i].markLine.data && t[i].markLine.data.length > 0 || t[i].nodes && t[i].nodes.length > 0 || t[i].links && t[i].links.length > 0 || t[i].matrix && t[i].matrix.length > 0 || t[i].eventList && t[i].eventList.length > 0)
                    return !1;
        ...
        _render: function(t) {
            ...
            !this._noDataCheck(t)) {
                ...
                for (var s, h, d, c = ["title", "legend", "tooltip", "dataRange", "roamController", "grid", "dataZoom", "xAxis", "yAxis", "polar"], m = 0, p = c.length; p > m; m++)
                    h = c[m],
                    d = this.component[h],
                    t[h] ? (d ? d.refresh && d.refresh(t) : (s = r.get(/^[xy]Axis$/.test(h) ? "axis" : h),
                    d = new s(this._themeConfig,this._messageCenter,this._zr,t,this,h),
                    this.component[h] = d),
                    this._chartList.push(d)) : d && (d.dispose(),
                    this.component[h] = null,
                    delete this.component[h]);
                for (var u, V, U, g = {}, m = 0, p = t.series.length; p > m; m++)
                    V = t.series[m].type,
                    V ? g[V] || (g[V] = !0,
                    u = o.get(V),
                    u ? (this.chart[V] ? (U = this.chart[V],
                    U.refresh(t)) : U = new u(this._themeConfig,this._messageCenter,this._zr,t,this),
                    this._chartList.push(U),
                    this.chart[V] = U) : console.error(V + " has not been required.")) : console.error("series[" + m + "] chart type has not been defined.");
                for (V in this.chart)
                    V == a.CHART_TYPE_ISLAND || g[V] || (this.chart[V].dispose(),
                    this.chart[V] = null,
                    delete this.chart[V]);
                ...
                t.renderAsImage && l ? (y ? y.src = this.getDataURL(t.renderAsImage) : (y = this.getImage(t.renderAsImage),
                y.id = f,
                ...
                this._zr.clear()) : y && y.parentNode.removeChild(y),
                y = null,
                this._option = t
            }
        },
        ...
        refresh: function(e) {
            ...
            e = e || {};
            var t = e.option;
            !this._refreshInside && t && (t = this.getOption(),
            ...
            this._toolbox.refresh(t),
            this._zr.clearAnimation();
            for (var i = 0, n = this._chartList.length; n > i; i++)
                this._chartList[i].refresh && this._chartList[i].refresh(t);
            this.component.grid && this.component.grid.refixAxisShape(this.component),
            this._zr.refresh()
        },
        ...
        _mergeGlobalConifg: function(t) {
            ...
            ,
            l || (t.animation = !1,
            t.addDataAnimation = !1)
        },
        setOption: function(e, t) {
            return e.timeline ? this._setTimelineOption(e) : this._setOption(e, t)
        },
        _setOption: function(e, t, i) {
            return !t && this._option ? this._option = o.merge(this.getOption(), o.clone(e), !0) : (this._option = o.clone(e),
                ...
                if (n)
                    if (n instanceof Array)
                        for (var a = n.length; a--; )
                            t[e][a].data = o.clone(n[a].data);
                    else
                        t[e].data = o.clone(n.data)
            }
        ...
        setSeries: function(e, t) {
            return t ? (this._option.series = e,
            this.setOption(this._option, t)) : this.setOption({
                series: e
            }),
            this
        },
        ...
        addData: function(e, t, i, n, r) {
            function s() {
                if (c._zr) {
                    ...
                    for (var e = 0, t = w.length; t > e; e++)
                        w[e].motionlessOnce = h.addDataAnimation && w[e].addDataAnimation;
                ...
                if (u) {
                    ...
                    null != r) {
                        ...
                        if (u.type === a.CHART_TYPE_PIE && (y = d.legend) && (b = y.data)) {
                            ...
                            (null == d.xAxis[L].type || "category" === d.xAxis[L].type) && (k = d.xAxis[L].data,
                            v = h.xAxis[L].data,
                            k[V](r),
                            v[V](r),
                            n || (k[U](),
                            v[U]())),
                            L = u.yAxisIndex || 0,
                            "category" === d.yAxis[L].type && (k = d.yAxis[L].data,
                            v = h.yAxis[L].data,
                            k[V](r),
                            v[V](r),
                            n || (k[U](),
            ...
            for (var w = this._chartList, W = 0, X = function() {
                W--,
                0 === W && s()
            }, m = 0, p = w.length; p > m; m++)
                h.addDataAnimation && w[m].addDataAnimation && (W++,
                w[m].addDataAnimation(l, X));
        ...
        _addMark: function(e, t, i) {
            ...
            if (a && (n = a[e])) {
                ...
                for (var d in t)
                    "data" === d ? (l.data = l.data.concat(t.data),
                    h.data = h.data.concat(t.data)) : "object" != typeof t[d] || null == l[d] ? l[d] = h[d] = t[d] : (o.merge(l[d], t[d], !0),
                    o.merge(h[d], t[d], !0));
        ...
        connect: function(e) {
            ...
            e instanceof Array)
                ...
                this._connected[e.id] = e;
            return this
        },
        disConnect: function(e) {
            if (!e || !this._connected)
                return this;
            if (e instanceof Array)
                for (var t = 0, i = e.length; i > t; t++)
                    delete this._connected[e[t].id];
            else
                delete this._connected[e.id];
        ...
        resize: function() {
            ...
            return function() {
                if (e._clearEffect(),
                e._zr.resize(),
                e._option && e._option.renderAsImage && l)
                    return e._render(e._option),
                    e;
                e._zr.clearAnimation(),
                e._island.resize(),
                e._toolbox.resize(),
                e._timeline && e._timeline.resize();
                for (var t = 0, i = e._chartList.length; i > t; t++)
...
define("zrender/tool/util", ["require", "../dep/excanvas"], function(e) {
    ...
    function l(e, t, i) {
        if (e && t)
            if (e.forEach && e.forEach === u)
                ...
                for (var o in e)
                    e.hasOwnProperty(o) && t.call(i, e[o], o, e)
    }
    function h(e, t, i) {
        if (e && t) {
            if (e.map && e.map === V)
            ...
            for (var n = [], a = 0, o = e.length; o > a; a++)
                n.push(t.call(i, e[a], a, e));
            return n
        }
    }
    function d(e, t, i) {
        if (e && t) {
            if (e.filter && e.filter === U)
                return e.filter(t, i);
            for (var n = [], a = 0, o = e.length; o > a; a++)
                t.call(i, e[a], a, e) && n.push(e[a]);
            return n
        }
    }
    function c(e, t) {
    ...
    var m, p = Array.prototype, u = p.forEach, V = p.map, U = p.filter, g = {
        "[object Function]": 1,
        "[object RegExp]": 1,
        "[object Date]": 1,
        "[object Error]": 1,
...
define("zrender/tool/env", [], function() {
    function e(e) {
        ...
        a && (t.android = !0,
        t.version = a[2]),
        s && !r && (t.ios = t.iphone = !0,
        t.version = s[2].replace(/_/g, ".")),
        o && (t.ios = t.ipad = !0,
        t.version = o[2].replace(/_/g, ".")),
        r && (t.ios = t.ipod = !0,
        t.version = r[3] ? r[3].replace(/_/g, ".") : null),
        l && (t.webos = !0,
        t.version = l[2]),
        h && (t.touchpad = !0),
        m && (t.blackberry = !0,
...
define("zrender/zrender", ["require", "./dep/excanvas", "./tool/util", "./tool/log", "./tool/guid", "./Handler", "./Painter", "./Storage", "./animation/Animation", "./tool/env"], function(e) {
    ...
    c.prototype.animate = function(e, t, a) {
        var o = this;
        if ("string" == typeof e && (e = this.storage.get(e)),
        e) {
            var r;
            if (t) {
                for (var s = t.split("."), l = e, h = 0, d = s.length; d > h; h++)
                    l && (l = l[s[h]]);
                l && (r = l)
            } else
                r = e;
            if (!r)
                return void n('Property "' + t + '" is not existed in element ' + e.id);
    ...
    c.prototype.stopAnimation = function(e) {
        if (e.__animators) {
            for (var t = e.__animators, i = t.length, n = 0; i > n; n++)
                t[n].stop();
            t.length = 0
        }
        return this
...
define("echarts/chart/island", ["require", "./base", "zrender/shape/Circle", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/event", "zrender/tool/color", "../util/accMath", "../chart"], function(e) {
    ...
    return t.prototype = {
        ...
        refresh: function(e) {
            e && (e.island = this.reformOption(e.island),
            this.option = e,
        ...
        del: function(e) {
            ...
            for (var t = [], i = 0, n = this.shapeList.length; n > i; i++)
                this.shapeList[i].id != e.id && t.push(this.shapeList[i]);
            this.shapeList = t
        },
        ondrop: function(e, t) {
        ...
        ondragend: function(e, t) {
            var i = e.target;
            this.isDragend ? t.dragIn && (this.del(i),
            t.needRefresh = !0) : t.dragIn || (i.style.x = s.getX(e.event),
            i.style.y = s.getY(e.event),
            this.add(i),
            t.needRefresh = !0),
            this.isDragend = !1
        }
...
define("echarts/component/toolbox", ["require", "./base", "zrender/shape/Line", "zrender/shape/Image", "zrender/shape/Rectangle", "../util/shape/Icon", "../config", "zrender/tool/util", "zrender/config", "zrender/tool/event", "./dataView", "../component"], function(e) {
    ...
    return t.prototype = {
        ...
        _buildShape: function() {
            ...
            for (var n in t)
                if (t[n].show)
                    ...
                    case "mark":
                        ...
                        break;
                    case "magicType":
                        for (var a = 0, o = t[n].type.length; o > a; a++)
                            t[n].title[t[n].type[a] + "Chart"] = t[n].title[t[n].type[a]],
            ...
            if (i.length > 0) {
                for (var r, n, a = 0, o = i.length; o > a; a++)
                    r = i[a].name,
                    n = i[a].key,
        ...
        _buildItem: function() {
            var t, i, n, o, s = this.option.toolbox, l = this._iconList.length, h = this._itemGroupLocation.x, d = this._itemGroupLocation.y, c = s.itemSize, m = s.itemGap, p = s.color instanceof Array ? s.color : [s.color], u = this.getFont(s.textStyle);
            "horizontal" === s.orient ? (i = this._itemGroupLocation.y / this.zr.getHeight() < .5 ? "bottom" : "top",
            n = this._itemGroupLocation.x / this.zr.getWidth() < .5 ? "left" : "right",
            o = this._itemGroupLocation.y / this.zr.getHeight() < .5 ? "top" : "bottom") : i = this._itemGroupLocation.x / this.zr.getWidth() < .5 ? "right" : "left",
            this._iconShapeMap = {};
            for (var V = this, U = 0; l > U; U++) {
                ...
                this._featureIcon[this._iconList[U]] && (t.style.image = this._featureIcon[this._iconList[U]].replace(new RegExp("^image:\\/\\/"), ""),
                t.style.opacity = .8,
                t.highlightStyle.opacity = 1,
                t.type = "image"),
                "horizontal" === s.orient && (0 === U && "left" === n && (t.highlightStyle.textPosition = "specific",
                t.highlightStyle.textAlign = n,
                t.highlightStyle.textBaseline = o,
                t.highlightStyle.textX = h,
                t.highlightStyle.textY = "top" === o ? d + c + 10 : d - 10),
                U === l - 1 && "right" === n && (t.highlightStyle.textPosition = "specific",
                t.highlightStyle.textAlign = n,
                t.highlightStyle.textBaseline = o,
                t.highlightStyle.textX = h + c,
                t.highlightStyle.textY = "top" === o ? d + c + 10 : d - 10)),
                this._iconList[U]) {
                case "mark":
                    t.onclick = V._onMark;
                ...
                case "saveAsImage":
                    ...
                    break;
                default:
                    this._iconList[U].match("Chart") ? (t._name = this._iconList[U].replace("Chart", ""),
                    t.onclick = V._onMagicType) : t.onclick = V._onCustomHandler
                }
        ...
        __onmousemove: function(e) {
            this._marking && (this._markShape.style.xEnd = d.getX(e.event),
            this._markShape.style.yEnd = d.getY(e.event),
            this.zr.addHoverShape(this._markShape)),
            this._zooming && (this._zoomShape.style.width = d.getX(e.event) - this._zoomShape.style.x,
            this._zoomShape.style.height = d.getY(e.event) - this._zoomShape.style.y,
        ...
        __onMarkUndo: function() {
            if (this._marking)
                ...
                if (e >= 1) {
                    ...
                    1 === e && (this._iconDisable(this._iconShapeMap.markUndo),
                    this._iconDisable(this._iconShapeMap.markClear))
                }
            }
            return !0
        ...
        _resetMark: function() {
            ...
            this.zr.un(h.EVENT.CLICK, this._onclick),
        ...
        __onMagicType: function(e) {
            ...
            return this._magicType[t] || (this._magicType[t] = !0,
            t === s.CHART_TYPE_LINE ? this._magicType[s.CHART_TYPE_BAR] = !1 : t === s.CHART_TYPE_BAR && (this._magicType[s.CHART_TYPE_LINE] = !1),
            t === s.CHART_TYPE_PIE ? this._magicType[s.CHART_TYPE_FUNNEL] = !1 : t === s.CHART_TYPE_FUNNEL && (this._magicType[s.CHART_TYPE_PIE] = !1),
            t === s.CHART_TYPE_FORCE ? this._magicType[s.CHART_TYPE_CHORD] = !1 : t === s.CHART_TYPE_CHORD && (this._magicType[s.CHART_TYPE_FORCE] = !1),
            t === c ? this._magicType[m] = !1 : t === m && (this._magicType[c] = !1),
            this.messageCenter.dispatch(s.EVENT.MAGIC_TYPE_CHANGED, e.event, {
        ...
        reset: function(e, t) {
            if (t && this.clear(),
            this.query(e, "toolbox.show") && this.query(e, "toolbox.feature.magicType.show")) {
                var i = e.toolbox.feature.magicType.type
                  , n = i.length;
                for (this._magicMap = {}; n--; )
                    this._magicMap[i[n]] = !0;
                n = e.series.length;
                for (var a, o; n--; )
                    a = e.series[n].type,
                    this._magicMap[a] && (o = e.xAxis instanceof Array ? e.xAxis[e.series[n].xAxisIndex || 0] : e.xAxis,
                    o && "category" === (o.type || "category") && (o.__boundaryGap = null != o.boundaryGap ? o.boundaryGap : !0),
                    o = e.yAxis instanceof Array ? e.yAxis[e.series[n].yAxisIndex || 0] : e.yAxis,
                    o && "category" === o.type && (o.__boundaryGap = null != o.boundaryGap ? o.boundaryGap : !0),
                    e.series[n].__type = a,
                    e.series[n].__itemStyle = l.clone(e.series[n].itemStyle || {})),
        ...
        getMagicOption: function() {
            ...
            if (this._magicType[s.CHART_TYPE_LINE] || this._magicType[s.CHART_TYPE_BAR]) {
                for (var i = this._magicType[s.CHART_TYPE_LINE] ? !1 : !0, n = 0, a = this.option.series.length; a > n; n++)
                    t = this.option.series[n].type,
                    (t == s.CHART_TYPE_LINE || t == s.CHART_TYPE_BAR) && (e = this.option.xAxis instanceof Array ? this.option.xAxis[this.option.series[n].xAxisIndex || 0] : this.option.xAxis,
                    e && "category" === (e.type || "category") && (e.boundaryGap = i ? !0 : e.__boundaryGap),
                    e = this.option.yAxis instanceof Array ? this.option.yAxis[this.option.series[n].yAxisIndex || 0] : this.option.yAxis,
                    e && "category" === e.type && (e.boundaryGap = i ? !0 : e.__boundaryGap));
                this._defaultMagic(s.CHART_TYPE_LINE, s.CHART_TYPE_BAR)
            }
            if (this._defaultMagic(s.CHART_TYPE_CHORD, s.CHART_TYPE_FORCE),
            this._defaultMagic(s.CHART_TYPE_PIE, s.CHART_TYPE_FUNNEL),
            this._magicType[c] || this._magicType[m])
                for (var n = 0, a = this.option.series.length; a > n; n++)
                    this._magicType[c] ? (this.option.series[n].stack = "_ECHARTS_STACK_KENER_2014_",
                    t = c) : this._magicType[m] && (this.option.series[n].stack = null,
                    t = m),
                    this._featureOption[t + "Chart"] && l.merge(this.option.series[n], this._featureOption[t + "Chart"] || {}, !0);
            return this.option
        },
        _defaultMagic: function(e, t) {
            if (this._magicType[e] || this._magicType[t])
                for (var i = 0, n = this.option.series.length; n > i; i++) {
                    ...
                    (a == e || a == t) && (this.option.series[i].type = this._magicType[e] ? e : t,
                    this.option.series[i].itemStyle = l.clone(this.option.series[i].__itemStyle),
                    a = this.option.series[i].type,
                    this._featureOption[a + "Chart"] && l.merge(this.option.series[i], this._featureOption[a + "Chart"] || {}, !0))
                }
        },
        silence: function(e) {
            this._isSilence = e
        ...
        clear: function(e) {
            ...
            this.shapeList = [],
            e || (this.zr.delShape(this._markShapeList),
            this._markShapeList = []))
        },
...
define("echarts/component/tooltip", ["require", "./base", "../util/shape/Cross", "zrender/shape/Line", "zrender/shape/Rectangle", "../config", "../util/ecData", "zrender/config", "zrender/tool/event", "zrender/tool/area", "zrender/tool/color", "zrender/tool/util", "zrender/shape/Base", "../component"], function(e) {
    ...
    return t.prototype = {
        ...
        _style: function(e) {
            ...
            e.backgroundColor && (t.push("background-Color:" + m.toHex(e.backgroundColor)),
            ...
            null != e.borderRadius && (t.push("border-radius:" + e.borderRadius + "px"),
            ...
            var n = e.textStyle;
            n && (n.color && t.push("color:" + n.color),
            n.decoration && t.push("text-decoration:" + n.decoration),
            n.align && t.push("text-align:" + n.align),
            n.fontFamily && t.push("font-family:" + n.fontFamily),
            n.fontSize && t.push("font-size:" + n.fontSize + "px"),
            n.fontSize && t.push("line-height:" + Math.round(3 * n.fontSize / 2) + "px"),
            n.fontStyle && t.push("font-style:" + n.fontStyle),
            n.fontWeight && t.push("font-weight:" + n.fontWeight));
            var a = e.padding;
            return null != a && (a = this.reformCssArray(a),
            t.push("padding:" + a[0] + "px " + a[1] + "px " + a[2] + "px " + a[3] + "px")),
            t = t.join(";") + ";"
        },
        __hide: function() {
        ...
        __tryShow: function() {
            ...
            if (this._curTarget) {
                ...
                null != i && null != n && e ? (t = this.deepQuery([n, i, this.option], "tooltip.trigger"),
                "axis" === t ? this._showAxisTrigger(i.xAxisIndex, i.yAxisIndex, l.get(this._curTarget, "dataIndex")) : this._showItemTrigger()) : (clearTimeout(this._hidingTicket),
        ...
        _findAxisTrigger: function() {
            ...
            for (var e, t, i = this.option.series, n = 0, a = i.length; a > n; n++)
                if ("axis" === this.deepQuery([i[n], this.option], "tooltip.trigger"))
                    return e = i[n].xAxisIndex || 0,
                    t = i[n].yAxisIndex || 0,
        ...
        _getNearestDataIndex: function(e, t) {
            ...
            if ("x" === e) {
                for (var o, r, s = this.component.grid.getXend(), l = t.getCoordByIndex(i); s > l && (r = l,
                n >= l); )
                    o = l,
            ...
            for (var h, c, m = this.component.grid.getY(), l = t.getCoordByIndex(i); l > m && (h = l,
            l >= a); )
                c = l,
                l = t.getCoordByIndex(++i);
        ...
        _showAxisTrigger: function(e, t, i) {
            if (!this._event.connectTrigger && this.messageCenter.dispatch(s.EVENT.TOOLTIP_IN_GRID, this._event, null, this.myChart),
            null == this.component.xAxis || null == this.component.yAxis || null == e || null == t)
                return clearTimeout(this._hidingTicket),
                clearTimeout(this._showingTicket),
                void (this._hidingTicket = setTimeout(this._hide, this._hideDelay));
            var n, a, o, r, l = this.option.series, h = [], c = [], m = "";
            ...
            if (V) {
                ...
                for (var g = 0, f = l.length; f > g; g++)
                    this._isSelected(l[g].name) && l[g][V + "Index"] === U && "axis" === this.deepQuery([l[g], this.option], "tooltip.trigger") && (r = this.query(l[g], "tooltip.showContent") || r,
                    a = this.query(l[g], "tooltip.formatter") || a,
                    o = this.query(l[g], "tooltip.position") || o,
                    m += this._style(this.query(l[g], "tooltip")),
                    null != l[g].stack && "xAxis" == V ? (h.unshift(l[g]),
                    c.unshift(g)) : (h.push(l[g]),
                    c.push(g)));
                ...
                var y;
                "xAxis" == V ? (p = this.subPixelOptimize(n.getCoordByIndex(i), this._axisLineWidth),
                u = d.getY(this._event),
                y = [p, this.component.grid.getY(), p, this.component.grid.getYend()]) : (p = d.getX(this._event),
                u = this.subPixelOptimize(n.getCoordByIndex(i), this._axisLineWidth),
                y = [this.component.grid.getX(), u, this.component.grid.getXend(), u]),
                this._styleAxisPointer(h, y[0], y[1], y[2], y[3], n.getGap(), p, u)
            } else
                p = d.getX(this._event),
                u = d.getY(this._event),
                this._styleAxisPointer(l, this.component.grid.getX(), u, this.component.grid.getXend(), u, 0, p, u),
                i >= 0 ? this._showItemTrigger(!0) : (clearTimeout(this._hidingTicket),
                clearTimeout(this._showingTicket),
            ...
            if (h.length > 0) {
                ...
                this._lastDataIndex != i || this._lastSeriesIndex != c[0]) {
                    ...
                    if ("function" == typeof a) {
                        for (var x = [], g = 0, f = h.length; f > g; g++)
                            b = h[g].data[i],
                        ...
                        for (var g = 0, f = h.length; f > g; g++)
                            a = a.replace("{a" + g + "}", this._encodeHTML(h[g].name || "")),
                        ...
                        for (var g = 0, f = h.length; f > g; g++)
                            a += "<br/>" + this._encodeHTML(h[g].name || "") + " : ",
                            b = h[g].data[i],
                            b = this.getDataFromOption(b, "-"),
                ...
                if (r === !1 || !this.option.tooltip.showContent)
                    return;
        ...
        _showPolarTrigger: function(e, t) {
            if (null == this.component.polar || null == e || null == t || 0 > t)
                return !1;
            ...
            for (var h = this.option.polar[e].indicator[t].text, c = 0, m = o.length; m > c; c++)
                this._isSelected(o[c].name) && o[c].polarIndex === e && "axis" === this.deepQuery([o[c], this.option], "tooltip.trigger") && (a = this.query(o[c], "tooltip.showContent") || a,
                i = this.query(o[c], "tooltip.formatter") || i,
                n = this.query(o[c], "tooltip.position") || n,
                l += this._style(this.query(o[c], "tooltip")),
                r.push(o[c]),
                s.push(c));
            if (r.length > 0) {
                for (var p, u, V, U = [], c = 0, m = r.length; m > c; c++) {
                    ...
                    for (var g = 0, f = p.length; f > g; g++)
                        ...
                        V = this.getDataFromOption(u.value[t]),
                        U.push({
                            seriesIndex: s[c],
                            seriesName: r[c].name || "",
                            series: r[c],
                ...
                this._lastDataIndex != t || this._lastSeriesIndex != s[0])
                    ...
                    "function" == typeof i)
                        ...
                        for (var c = 0, m = U.length; m > c; c++)
                            i = i.replace("{a" + c + "}", this._encodeHTML(U[c].seriesName)),
                        ...
                        for (var c = 1, m = U.length; m > c; c++)
                            i += "<br/>" + this._encodeHTML(U[c].name) + "<br/>",
                            i += this._encodeHTML(U[c].indicator) + " : " + this.numAddCommas(U[c].value);
                        this._tDom.innerHTML = i
                    }
                if (a === !1 || !this.option.tooltip.showContent)
                    return;
        ...
        _showItemTrigger: function(e) {
            if (this._curTarget) {
                var t, i, n, a = l.get(this._curTarget, "series"), o = l.get(this._curTarget, "seriesIndex"), r = l.get(this._curTarget, "data"), h = l.get(this._curTarget, "dataIndex"), c = l.get(this._curTarget, "name"), m = l.get(this._curTarget, "value"), p = l.get(this._curTarget, "special"), u = l.get(this._curTarget, "special2"), V = [r, a, this.option], U = "";
                if ("island" != this._curTarget._type) {
                    var g = e ? "axis" : "item";
                    this.option.tooltip.trigger === g && (t = this.option.tooltip.formatter,
                    i = this.option.tooltip.position),
                    this.query(a, "tooltip.trigger") === g && (n = this.query(a, "tooltip.showContent") || n,
                    t = this.query(a, "tooltip.formatter") || t,
                    i = this.query(a, "tooltip.position") || i,
                ...
                "function" == typeof t ? (this._curTicket = (a.name || "") + ":" + h,
                this._tDom.innerHTML = t.call(this.myChart, {
                    seriesIndex: o,
                    seriesName: a.name || "",
                    series: a,
                    dataIndex: h,
                    ...
                    6: o,
                    7: h
                }, this._curTicket, this._setContent)) : "string" == typeof t ? (this._curTicket = 0 / 0,
                t = t.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"),
                t = t.replace("{a0}", this._encodeHTML(a.name || "")).replace("{b0}", this._encodeHTML(c)).replace("{c0}", m instanceof Array ? m : this.numAddCommas(m)),
                t = t.replace("{d}", "{d0}").replace("{d0}", p || ""),
                t = t.replace("{e}", "{e0}").replace("{e0}", l.get(this._curTarget, "special2") || ""),
                this._tDom.innerHTML = t) : (this._curTicket = 0 / 0,
                this._tDom.innerHTML = a.type === s.CHART_TYPE_RADAR && p ? this._itemFormatter.radar.call(this, a, c, m, p) : a.type === s.CHART_TYPE_EVENTRIVER ? this._itemFormatter.eventRiver.call(this, a, c, m, r) : "" + (null != a.name ? this._encodeHTML(a.name) + "<br/>" : "") + ("" === c ? "" : this._encodeHTML(c) + " : ") + (m instanceof Array ? m : this.numAddCommas(m))));
                ...
                n !== !1 && this.option.tooltip.showContent && (this.hasAppend || (this._tDom.style.left = this._zrWidth / 2 + "px",
                this._tDom.style.top = this._zrHeight / 2 + "px",
                this.dom.firstChild.appendChild(this._tDom),
                this.hasAppend = !0),
                this._show(i, f + 20, y - 20, U))
            }
        },
        _itemFormatter: {
            radar: function(e, t, i, n) {
                ...
                for (var o = 0; o < n.length; o++)
                    a += this._encodeHTML(n[o].text) + " : " + this.numAddCommas(i[o]) + "<br />";
                return a
            },
            chord: function(e, t, i, n, a) {
                if (null == a)
                    return this._encodeHTML(t) + " (" + this.numAddCommas(i) + ")";
            ...
            eventRiver: function(e, t, i, n) {
                ...
                for (var o = 0, r = n.length; r > o; o++)
                    ...
                    n[o].detail && (n[o].detail.img && (a += '<img src="' + n[o].detail.img + '" style="float:left;width:40px;height:40px;">'),
                    a += '<div style="margin-left:45px;">' + n[o].time + "<br/>",
                    a += '<a href="' + n[o].detail.link + '" target="_blank">',
                    a += n[o].detail.text + "</a></div>",
                    a += "</div>");
                return a
            }
        },
        _styleAxisPointer: function(e, t, i, n, a, o, r, s) {
            if (e.length > 0) {
                var l, h, d = this.option.tooltip.axisPointer, c = d.type, m = {
                    line: {},
                    cross: {},
                    shadow: {}
                };
                for (var p in m)
                    m[p].color = d[p + "Style"].color,
                ...
                for (var u = 0, V = e.length; V > u; u++)
                    ...
                    c = h || c,
                    h && (m[h].color = this.query(l, "tooltip.axisPointer." + h + "Style.color") || m[h].color,
                    m[h].width = this.query(l, "tooltip.axisPointer." + h + "Style.width") || m[h].width,
                    m[h].type = this.query(l, "tooltip.axisPointer." + h + "Style.type") || m[h].type);
                if ("line" === c) {
                    var U = m.line.width
                      , g = t == n;
                    ...
                    this.component.grid.getXend() - r > 100 ? (this._axisCrossShape.style.textAlign = "left",
                    this._axisCrossShape.style.textX = r + 10) : (this._axisCrossShape.style.textAlign = "right",
                    this._axisCrossShape.style.textX = r - 10),
                    s - this.component.grid.getY() > 50 ? (this._axisCrossShape.style.textBaseline = "bottom",
                    this._axisCrossShape.style.textY = s - 10) : (this._axisCrossShape.style.textBaseline = "top",
                    this._axisCrossShape.style.textY = s + 10),
                    this._axisCrossShape.invisible = !1,
                    this.zr.modShape(this._axisCrossShape.id)
                } else
                    "shadow" === c && ((null == m.shadow.width || "auto" === m.shadow.width || isNaN(m.shadow.width)) && (m.shadow.width = o),
                    t === n ? Math.abs(this.component.grid.getX() - t) < 2 ? (m.shadow.width /= 2,
                    t = n += m.shadow.width / 2) : Math.abs(this.component.grid.getXend() - t) < 2 && (m.shadow.width /= 2,
                    t = n -= m.shadow.width / 2) : i === a && (Math.abs(this.component.grid.getY() - i) < 2 ? (m.shadow.width /= 2,
                    i = a += m.shadow.width / 2) : Math.abs(this.component.grid.getYend() - i) < 2 && (m.shadow.width /= 2,
                    i = a -= m.shadow.width / 2)),
        ...
        __onmousemove: function(e) {
            ...
            !this._mousein || !this._enterable) {
                ...
                if (t) {
                    ...
                    this._event.zrenderX = i,
                    this._event.zrenderY = n,
                    this._needAxisTrigger && this.component.grid && c.isInside(r, this.component.grid.getArea(), i, n) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : this._needAxisTrigger && this.component.polar && -1 != this.component.polar.isInside([i, n]) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : (!this._event.connectTrigger && this.messageCenter.dispatch(s.EVENT.TOOLTIP_OUT_GRID, this._event, null, this.myChart),
                    this._hidingTicket = setTimeout(this._hide, this._hideDelay))
            }
        },
        ...
        __setContent: function(e, t) {
            this._tDom && (e === this._curTicket && (this._tDom.innerHTML = t),
                    ...
                    if (d)
                        if (c) {
                            ...
                            case s.CHART_TYPE_RADAR:
                                if (null == this.component.polar || r.data[0].value.length <= m)
                                    return;
...
define("echarts/component/legend", ["require", "./base", "zrender/shape/Text", "zrender/shape/Rectangle", "zrender/shape/Sector", "../util/shape/Icon", "../util/shape/Candle", "../config", "zrender/tool/util", "zrender/tool/area", "../component"], function(e) {
    ...
    t.prototype = {
        ...
        _buildItem: function() {
            var e, t, i, a, o, s, l, c, m = this.legendOption.data, p = m.length, u = this.legendOption.textStyle, V = this.zr.getWidth(), U = this.zr.getHeight(), g = this._itemGroupLocation.x, f = this._itemGroupLocation.y, y = this.legendOption.itemWidth, b = this.legendOption.itemHeight, _ = this.legendOption.itemGap;
            "vertical" === this.legendOption.orient && "right" === this.legendOption.x && (g = this._itemGroupLocation.x + this._itemGroupLocation.width - y);
            for (var x = 0; p > x; x++)
                o = h.merge(m[x].textStyle || {}, u),
                s = this.getFont(o),
                e = this._getName(m[x]),
                l = this._getFormatterName(e),
                "" !== e ? (t = m[x].icon || this._getSomethingByName(e).type,
                c = this.getColor(e),
                "horizontal" === this.legendOption.orient ? 200 > V - g && y + 5 + d.getTextWidth(l, s) + (x === p - 1 || "" === m[x + 1] ? 0 : _) >= V - g && (g = this._itemGroupLocation.x,
                f += b + _) : 200 > U - f && b + (x === p - 1 || "" === m[x + 1] ? 0 : _) >= U - f && ("right" === this.legendOption.x ? g -= this._itemGroupLocation.maxWidth + _ : g += this._itemGroupLocation.maxWidth + _,
                f = this._itemGroupLocation.y),
                i = this._getItemShapeByType(g, f, y, b, this._selectedMap[e] && this._hasDataMap[e] ? c : "#ccc", t, c),
                i._name = e,
                i = new r(i),
                a = {
                    zlevel: this.getZlevelBase(),
                ...
                "vertical" === this.legendOption.orient && "right" === this.legendOption.x && (a.style.x -= y + 10,
                a.style.textAlign = "right"),
                a._name = e,
                a = new n(a),
                this.legendOption.selectedMode && (i.onclick = a.onclick = this._legendSelected,
                i.onmouseover = a.onmouseover = this._dispatchHoverLink,
                i.hoverConnect = a.id,
                a.hoverConnect = i.id),
                this.shapeList.push(i),
                this.shapeList.push(a),
                "horizontal" === this.legendOption.orient ? g += y + 5 + d.getTextWidth(l, s) + _ : f += b + _) : "horizontal" === this.legendOption.orient ? (g = this._itemGroupLocation.x,
                f += b + _) : ("right" === this.legendOption.x ? g -= this._itemGroupLocation.maxWidth + _ : g += this._itemGroupLocation.maxWidth + _,
                f = this._itemGroupLocation.y);
        ...
        _mLineOptimize: function() {
            for (var e = [], t = this._itemGroupLocation.x, i = 2, n = this.shapeList.length; n > i; i++)
                this.shapeList[i].style.x === t ? e.push((this._itemGroupLocation.width - (this.shapeList[i - 1].style.x + d.getTextWidth(this.shapeList[i - 1].style.text, this.shapeList[i - 1].style.textFont) - t)) / 2) : i === n - 1 && e.push((this._itemGroupLocation.width - (this.shapeList[i].style.x + d.getTextWidth(this.shapeList[i].style.text, this.shapeList[i].style.textFont) - t)) / 2);
            for (var a = -1, i = 1, n = this.shapeList.length; n > i; i++)
                this.shapeList[i].style.x === t && a++,
        ...
        _getItemGroupLocation: function() {
            ...
            if ("horizontal" === this.legendOption.orient) {
                ...
                for (var U = 0; t > U; U++)
                    V = Math.max(V, d.getTextWidth(this._getFormatterNameFromData(e[U]), e[U].textStyle ? this.getFont(h.merge(e[U].textStyle || {}, o)) : r));
                V += n,
                s = V;
                for (var U = 0; t > U; U++)
                    "" !== this._getName(e[U]) ? u + a + i > p ? (s += V + i,
                    u -= i,
                    l = Math.max(l, u),
                    u = 0) : (u += a + i,
                    l = Math.max(l, u - i)) : (s += V + i,
                    u -= i,
                    l = Math.max(l, u),
                    u = 0)
            }
        ...
        __legendSelected: function(e) {
            ...
            if ("single" === this.legendOption.selectedMode)
                for (var i in this._selectedMap)
                    this._selectedMap[i] = !1;
            ...
            if (e) {
                ...
                if (this.legendOption.selected)
                    for (var r in this.legendOption.selected)
                        this._selectedMap[r] = "undefined" != typeof this._selectedMap[r] ? this._selectedMap[r] : this.legendOption.selected[r];
                for (var s = 0, h = o.length; h > s; s++)
                    t = this._getName(o[s]),
                    "" !== t && (i = this._getSomethingByName(t),
                    i.series ? (this._hasDataMap[t] = !0,
                    a = !i.data || i.type !== l.CHART_TYPE_PIE && i.type !== l.CHART_TYPE_FORCE && i.type !== l.CHART_TYPE_FUNNEL ? [i.series] : [i.data, i.series],
                    n = this.getItemStyleColor(this.deepQuery(a, "itemStyle.normal.color"), i.seriesIndex, i.dataIndex, i.data),
                    n && i.type != l.CHART_TYPE_K && this.setColor(t, n),
                    this._selectedMap[t] = null != this._selectedMap[t] ? this._selectedMap[t] : !0) : this._hasDataMap[t] = !1)
            }
            this.clear(),
            this._buildShape()
        },
        getRelatedAmount: function(e) {
            for (var t, i = 0, n = this.option.series, a = 0, o = n.length; o > a; a++)
                if (n[a].name === e && i++,
                n[a].type === l.CHART_TYPE_PIE || n[a].type === l.CHART_TYPE_RADAR || n[a].type === l.CHART_TYPE_CHORD || n[a].type === l.CHART_TYPE_FORCE || n[a].type === l.CHART_TYPE_FUNNEL) {
                    t = n[a].type != l.CHART_TYPE_FORCE ? n[a].data : n[a].categories;
                    for (var r = 0, s = t.length; s > r; r++)
                        t[r].name === e && "-" != t[r].value && i++
                }
            return i
        },
        ...
        del: function(e) {
            for (var t = this.legendOption.data, i = 0, n = t.length; n > i; i++)
                if (this._getName(t[i]) === e)
                    return this.legendOption.data.splice(i, 1)
        },
        getItemShape: function(e) {
            if (null != e)
                for (var t, i = 0, n = this.shapeList.length; n > i; i++)
                    if (t = this.shapeList[i],
                    t._name === e && "text" != t.type)
                        return t
        },
        setItemShape: function(e, t) {
            for (var i, n = 0, a = this.shapeList.length; a > n; n++)
                i = this.shapeList[n],
                i._name === e && "text" != i.type && (this._selectedMap[e] || (t.style.color = "#ccc",
                t.style.strokeColor = "#ccc"),
                this.zr.modShape(i.id, t))
        },
        ...
        onlegendSelected: function(e, t) {
            var i = e.selected;
            for (var n in i)
                this._selectedMap[n] != i[n] && (t.needRefresh = !0),
    ...
    var c = {
        ...
        radar: function(e, t) {
            ...
            for (var d = 0, c = i - 1; c > d; d++)
                e.lineTo(n + o * Math.cos(s), a + o * Math.sin(s)),
                s += r;
            e.lineTo(l, h)
        }
    };
    ...
    c.map = c.bar;
    for (var m in c)
        r.prototype.iconLibrary["legendicon" + m] = c[m];
...
define("zrender/tool/color", ["require", "../tool/util"], function(e) {
    ...
    function s(e, t, i, n, a, o, r) {
        O || (O = P.getContext());
        for (var s = O.createRadialGradient(e, t, i, n, a, o), l = 0, h = r.length; h > l; l++)
            s.addColorStop(r[l][0], r[l][1]);
        return s.__nonRecursion = !0,
        s
    }
    function l(e, t, i, n, a) {
        O || (O = P.getContext());
        for (var o = O.createLinearGradient(e, t, i, n), r = 0, s = a.length; s > r; r++)
            o.addColorStop(a[r][0], a[r][1]);
    ...
    function h(e, t, i) {
        ...
        e = S(e),
        t = S(t);
        for (var n = [], a = (t[0] - e[0]) / i, o = (t[1] - e[1]) / i, r = (t[2] - e[2]) / i, s = (t[3] - e[3]) / i, l = 0, h = e[0], d = e[1], m = e[2], p = e[3]; i > l; l++)
            n[l] = c([T(Math.floor(h), [0, 255]), T(Math.floor(d), [0, 255]), T(Math.floor(m), [0, 255]), p.toFixed(4) - 0], "rgba"),
            h += a,
            d += o,
            m += r,
            p += s;
    ...
    function c(e, t) {
        ...
        e && (3 === e.length || 4 === e.length)) {
            ...
            return t.indexOf("a") > -1 ? (3 === e.length && e.push(1),
            e[3] = T(e[3], [0, 1]),
            t + "(" + e.slice(0, 4).join(",") + ")") : t + "(" + e.slice(0, 3).join(",") + ")"
        }
    }
    function m(e) {
        e = v(e),
    ...
    function w(e, t) {
        ...
        e = V(e);
        for (var n = S(e), a = 0; 3 > a; a++)
            n[a] = 1 === i ? n[a] * (1 - t) | 0 : (255 - n[a]) * t + n[a] | 0;
        return "rgb(" + n.join(",") + ")"
    }
    function W(e) {
        if (!E(e))
    ...
    function X(e, t, i) {
        ...
        i = 1 - T(i, [0, 1]);
        for (var n = 2 * i - 1, a = S(u(e)), o = S(u(t)), r = a[3] - o[3], s = ((n * r === -1 ? n : (n + r) / (1 + n * r)) + 1) / 2, l = 1 - s, h = [], d = 0; 3 > d; d++)
            h[d] = a[d] * s + o[d] * l;
        var m = a[3] * i + o[3] * (1 - i);
        return m = Math.max(0, Math.min(1, m)),
        1 === a[3] && 1 === o[3] ? c(h, "rgb") : (h[3] = m,
        c(h, "rgba"))
    }
    function I() {
    ...
    function C(e, t) {
        if ("function" != typeof t)
            throw new TypeError;
        for (var i = e ? e.length : 0, n = 0; i > n; n++)
            e[n] = t(e[n]);
        return e
    }
    function T(e, t) {
    ...
    var O, P = e("../tool/util"), D = ["#ff9277", " #dddd00", " #ffc877", " #bbe3ff", " #d5ffbb", "#bbbbff", " #ddb000", " #b0dd00", " #e2bbff", " #ffbbe3", "#ff7777", " #ff9900", " #83dd00", " #77e3ff", " #778fff", "#c877ff", " #ff77ab", " #ff6600", " #aa8800", " #77c7ff", "#ad77ff", " #ff77ff", " #dd0083", " #777700", " #00aa00", "#0088aa", " #8400dd", " #aa0088", " #dd0000", " #772e00"], N = D, B = "rgba(255,255,0,0.5)", H = B, R = /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i, G = {
        aliceblue: "#f0f8ff",
        antiquewhite: "#faebd7",
        aqua: "#0ff",
        aquamarine: "#7fffd4",
    ...
    function t(e, t, i, a, o) {
        ...
        r._onFrame = function() {
            ...
            r.timelineOption.autoPlay && (r.playTicket = setTimeout(function() {
                ...
                !r.timelineOption.loop && r.currentIndex >= r.timelineOption.data.length ? (r.currentIndex = r.timelineOption.data.length - 1,
                void r.stop()) : void r._onFrame()
        ...
        this.timelineOption.notMerge || 0 === this.currentIndex || (this.options[this.currentIndex] = l.merge(this.options[this.currentIndex], this.options[0])),
    ...
    return t.prototype = {
        ...
        _buildShape: function() {
            ...
            this.timelineOption.label.show)
                for (var e = this._getInterval(), t = 0, i = this._chainPoint.length; i > t; t += e)
        ...
        _getLocation: function() {
            ...
            null == t.width ? (e = n - a - o,
            o = n - o) : (e = this.parsePercent(t.width, n),
            o = a + e);
            var r, s, l = this.zr.getHeight(), h = this.parsePercent(t.height, l);
            return null != t.y ? (r = this.parsePercent(t.y, l),
            s = r + h) : (s = l - this.parsePercent(t.y2, l),
            r = s - h),
            {
                x: a + i[3],
                y: r + i[0],
                ...
                if (o > 3) {
                    ...
                    for (i = 0; !l && o > i; ) {
                        ...
                        for (var d = i; o > d; d += i) {
                            ...
                            0 !== t.label.rotate)
                                s = n;
                            else if (a[d].textStyle)
                                s = h.getTextWidth(e[d].name, e[d].textFont);
                            else {
                                var c = e[d].name + ""
        ...
        _getChainPoint: function() {
            ...
            var t, i = this.timelineOption, n = i.symbol.toLowerCase(), a = i.symbolSize, o = i.label.rotate, r = i.label.textStyle, s = this.getFont(r), h = i.data, d = this._location.x, c = this._location.y + this._location.height / 4 * 3, m = this._location.x2 - this._location.x, p = h.length, u = [];
            if (p > 1) {
                var V = m / p;
                if (V = V > 50 ? 50 : 20 > V ? 5 : V,
                m -= 2 * V,
                "number" === i.type)
                    for (var U = 0; p > U; U++)
                        u.push(d + V + m / (p - 1) * U);
                    ...
                    for (var U = 1; p > U; U++)
                        u[U] = d + V + m * (new Date(e(U).replace(/-/g, "/")) - u[0]) / u[p - 1];
                    u[0] = d + V
                }
            } else
                u.push(d + m / 2);
            for (var g, f, y, b, _, x = [], U = 0; p > U; U++)
                d = u[U],
                g = h[U].symbol && h[U].symbol.toLowerCase() || n,
                g.match("empty") ? (g = g.replace("empty", ""),
                y = !0) : y = !1,
                g.match("star") && (f = g.replace("star", "") - 0 || 5,
                g = "star"),
                t = h[U].textStyle ? l.merge(h[U].textStyle || {}, r) : r,
                b = t.align || "center",
                o ? (b = o > 0 ? "right" : "left",
                _ = [o * Math.PI / 180, d, c - 5]) : _ = !1,
                x.push({
                    x: d,
                    n: f,
                    isEmpty: y,
        ...
        _buildControl: function() {
            ...
            if ("none" !== t.controlPosition) {
                var a, r = n.itemSize, s = n.itemGap;
                "left" === t.controlPosition ? (a = this._location.x,
                this._location.x += 3 * (r + s)) : (a = this._location.x2 - (3 * (r + s) - s),
                this._location.x2 -= 3 * (r + s));
        ...
        _syncHandleShape: function() {
            if (this.timelineOption.show) {
                ...
                "auto" === t.symbol ? this._handleShape.style.iconType = "none" != i.symbol ? i.symbol : "diamond" : (this._handleShape.style.iconType = t.symbol,
                t.symbol.match("star") && (this._handleShape.style.n = t.symbol.replace("star", "") - 0 || 5,
                this._handleShape.style.iconType = "star"));
                var n;
                "auto" === t.symbolSize ? (n = i.symbolSize + 2,
                n = 5 > n ? 5 : n) : n = t.symbolSize - 0,
        ...
        _findChainIndex: function(e) {
            ...
            if (e >= t[i - 1].x)
                return i - 1;
            for (var n = 0; i - 1 > n; n++)
                if (e >= t[n].x && e <= t[n + 1].x)
                    return Math.abs(e - t[n].x) < Math.abs(e - t[n + 1].x) ? n : n + 1
        },
        __onclick: function(e) {
            var t = d.getX(e.event)
              , i = this._findChainIndex(t);
            return i === this.currentIndex ? !0 : (this.currentIndex = i,
        ...
        __ondrift: function(e, t) {
            ...
            e.style.x + t <= n[0].x - n[0].symbolSize ? (e.style.x = n[0].x - n[0].symbolSize,
            i = 0) : e.style.x + t >= n[a - 1].x - n[a - 1].symbolSize ? (e.style.x = n[a - 1].x - n[a - 1].symbolSize,
            i = a - 1) : (e.style.x += t,
            i = this._findChainIndex(e.style.x));
            var o = n[i]
              , r = o.symbolSize + 2;
            if (e.style.iconType = o.symbol,
            e.style.n = o.n,
            e.style.textX = e.style.x + r / 2,
            e.style.y = this._location.y + this._location.height / 4 - r,
            e.style.width = 2 * r,
            e.style.height = 2 * r,
            e.style.text = o.name,
            i === this.currentIndex)
        ...
        ondragend: function(e, t) {
            this.isDragend && e.target && (!this.timelineOption.realtime && this._setCurrentOption(),
            t.dragOut = !0,
            t.dragIn = !0,
            t.needRefresh = !1,
            this.isDragend = !1,
        ...
        setTheme: function(e) {
            ...
            this.timelineOption.show && e && (this.clear(),
            this._buildShape(),
            this._syncHandleShape())
        },
        onbeforDispose: function() {
...
define("zrender/shape/Image", ["require", "./Base", "../tool/util"], function(e) {
    ...
    return i.prototype = {
        ...
        brush: function(e, t, i) {
            ...
            "string" == typeof a) {
                var r = a;
                this._imageCache[r] ? a = this._imageCache[r] : (a = new Image,
                a.onload = function() {
                    a.onload = null,
                    o.modSelf(),
                    i()
...
define("zrender/loadingEffect/Bar", ["require", "./Base", "../tool/util", "../tool/color", "../shape/Rectangle"], function(e) {
    ...
    t.prototype._start = function(e, t) {
        ...
        null != i.progress ? (e(s),
        h.highlightStyle.width = this.adjust(i.progress, [0, 1]) * i.effectOption.width,
        e(h),
        e(r),
        void t()) : (h.highlightStyle.width = 0,
    ...
    t.prototype._start = function(e, t) {
        ...
        return setInterval(function() {
            ...
            for (var i = 0; h > i; i++) {
                ...
                n.y - m[i].animationY + n.r <= 0 && (m[i].highlightStyle.y = u + n.r,
                m[i].highlightStyle.x = Math.ceil(Math.random() * p)),
    ...
    t.prototype._start = function(e, t) {
        ...
        return setInterval(function() {
            ...
            for (var i = 0; h > i; i++) {
                ...
                n.xStart >= m && (c[i].len = Math.ceil(400 * Math.random()),
                n.xStart = -400,
                n.xEnd = -400 + c[i].len,
                n.yStart = Math.ceil(Math.random() * p),
                n.yEnd = n.yStart),
...
define("zrender/loadingEffect/Ring", ["require", "./Base", "../tool/util", "../tool/color", "../shape/Ring", "../shape/Sector"], function(e) {
    ...
    t.prototype._start = function(e, t) {
        ...
        }), f = [], y = a.getGradientColors(["#ff6400", "#ffe100", "#97ff00"], 25), b = 15, _ = 240, x = 0; 16 > x; x++)
            f.push(new r({
                highlightStyle: {
                    x: c,
                    y: m,
        ...
        if (null != i.progress) {
            ...
            e(g);
            for (var x = 0; 20 > x; x++)
                f[x].highlightStyle.color = k > x ? f[x]._color : U,
                e(f[x]);
            return e(h),
            void t()
        }
        return setInterval(function() {
            ...
            e(g);
            for (var i = 0; 20 > i; i++)
                f[i].highlightStyle.color = k > i ? f[i]._color : U,
                e(f[i]);
            e(h),
            t()
        }, s.timeInterval)
...
define("zrender/loadingEffect/Spin", ["require", "./Base", "../tool/util", "../tool/color", "../tool/area", "../shape/Sector"], function(e) {
    ...
    t.prototype._start = function(e, t) {
        ...
        for (var p = this.createBackgroundShape(i.backgroundColor), u = c.n, V = c.x, U = c.y, g = c.r0, f = c.r, y = c.color, b = [], _ = Math.round(180 / u), x = 0; u > x; x++)
            b[x] = new r({
                highlightStyle: {
                    x: V,
                    y: U,
...
define("zrender/dep/excanvas", ["require"], function() {
    return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : !function() {
        ...
        function a(e) {
            if (n(e, "g_vml_", "urn:schemas-microsoft-com:vml"),
            n(e, "g_o_", "urn:schemas-microsoft-com:office:office"),
        ...
        function V(e) {
            ...
            "#" == e.charAt(0))
                ...
                for (var n, a = d(e), t = "#", o = 0; 3 > o; o++)
                    n = -1 != a[o].indexOf("%") ? Math.floor(255 * c(a[o])) : +a[o],
                    t += D[m(n, 0, 255)];
                i = +a[3]
            } else if (/^hsl/.test(e)) {
                var a = d(e);
        ...
        function w(e, t, i) {
            if (L(t) && (e.m_ = t,
            e.scaleX_ = Math.sqrt(t[0][0] * t[0][0] + t[0][1] * t[0][1]),
            e.scaleY_ = Math.sqrt(t[1][0] * t[1][0] + t[1][1] * t[1][1]),
            i)) {
        ...
        var C = Math
          ...
          , F = 10
          , J = F / 2
          , O = (+navigator.userAgent.match(/MSIE ([\d.]+)?/)[1],
        ...
        var P = {
            ...
            init_: function(e) {
                for (var t = e.getElementsByTagName("canvas"), i = 0; i < t.length; i++)
                    this.initElement(t[i])
            },
        ...
        for (var D = [], N = 0; 16 > N; N++)
            for (var B = 0; 16 > B; B++)
                D[16 * N + B] = N.toString(16) + B.toString(16);
        var H = {
            aliceblue: "#F0F8FF",
            antiquewhite: "#FAEBD7",
            aquamarine: "#7FFFD4",
        ...
        Q.drawImage = function(e) {
            ...
            var c = e.width
              , m = e.height;
            if (e.runtimeStyle.width = h,
            e.runtimeStyle.height = d,
            3 == arguments.length)
                t = arguments[1],
                i = arguments[2],
                o = r = 0,
            ...
            var p = v(this, t, i)
              ...
              , U = 10
              , g = y = 1;
            if (u.push(" <g_vml_:group", ' coordsize="', F * V, ",", F * U, '"', ' coordorigin="0,0"', ' style="width:', V, "px;height:", U, "px;position:absolute;"),
            1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
                ...
                u.push("top:", T(p.y / F), "px;left:", T(p.x / F), "px;");
            u.push(' ">'),
        ...
        Q.stroke = function(e) {
            ...
            for (var a = {
                ...
                l && ((null == a.x || l.x < a.x) && (a.x = l.x),
                (null == o.x || l.x > o.x) && (o.x = l.x),
                (null == a.y || l.y < a.y) && (a.y = l.y),
                (null == o.y || l.y > o.y) && (o.y = l.y))
            }
            t.push(' ">'),
...
define("zrender/mixin/Eventful", ["require"], function() {
    ...
    e.prototype.unbind = function(e, t) {
        ...
        if (t) {
            if (i[e]) {
                for (var n = [], a = 0, o = i[e].length; o > a; a++)
...
define("zrender/Handler", ["require", "./config", "./tool/env", "./tool/event", "./tool/util", "./tool/vector", "./tool/matrix", "./mixin/Eventful"], function(e) {
    ...
    function a(e, t, i) {
        if (this._draggingTarget && this._draggingTarget.id == e.id || e.isSilent())
            return !1;
        var n = this._event;
        if (e.isCover(t, i)) {
            e.hoverable && this.storage.addHover(e);
            for (var a = e.parent; a; ) {
                if (a.clipShape && !a.clipShape.isCover(this._mouseX, this._mouseY))
                    return !1;
                a = a.parent
            }
            return this._lastHover != e && (this._processOutShape(n),
            this._processDragLeave(n),
            this._lastHover = e,
            this._processDragEnter(n)),
    ...
    var o = e("./config")
      ...
      , V = {
        ...
        click: function(e, t) {
            if (u(e) || t) {
                ...
                (i && i.clickable || !i) && this._clickThreshold < 5 && this._dispatchAgency(i, c.CLICK, e),
        ...
        dblclick: function(e, t) {
            if (u(e) || t) {
                ...
                e = this._zrenderEventFixed(e);
                var i = this._lastHover;
                (i && i.clickable || !i) && this._clickThreshold < 5 && this._dispatchAgency(i, c.DBLCLICK, e),
                this._mousemoveHandler(e)
            }
        },
        ...
        mousemove: function(e, t) {
            if ((u(e) || t) && !this.painter.isLoading()) {
                ...
                this._hasfound || ((!this._draggingTarget || this._lastHover && this._lastHover != this._draggingTarget) && (this._processOutShape(e),
                this._processDragLeave(e)),
                this._lastHover = null,
                this.storage.delHover(),
                this.painter.clearHover());
                var a = "default";
                if (this._draggingTarget)
                    this.storage.drift(this._draggingTarget.id, i, n),
        ...
        mouseout: function(e, t) {
            if (u(e) || t) {
                ...
                if (i != this.root)
                    for (; i && 9 != i.nodeType; ) {
                        if (i == this.root)
                            return void this._mousemoveHandler(e);
                        i = i.parentNode
                    }
        ...
        mousedown: function(e, t) {
            if (u(e) || t) {
                ...
                2 == this._lastDownButton)
                    return this._lastDownButton = e.button,
        ...
        mouseup: function(e, t) {
            (u(e) || t) && (e = this._zrenderEventFixed(e),
            this.root.style.cursor = "default",
            this._isMouseDown = 0,
            this._mouseDownTarget = null,
            this._dispatchAgency(this._lastHover, c.MOUSEUP, e),
            this._processDrop(e),
            this._processDragEnd(e))
        },
        touchstart: function(e, t) {
            (u(e) || t) && (e = this._zrenderEventFixed(e, !0),
        ...
        touchend: function(e, t) {
            if (u(e) || t) {
                ...
                var i = new Date;
                i - this._lastTouchMoment < c.touchClickDelay && (this._mobileFindFixed(e),
                this._clickHandler(e),
                i - this._lastClickMoment < c.touchClickDelay / 2 && (this._dblclickHandler(e),
                this._lastHover && this._lastHover.clickable && s.stop(e)),
      ...
      , U = function(e, t, o) {
        ...
        r.os.tablet || r.os.phone ? (e.addEventListener("touchstart", this._touchstartHandler),
        e.addEventListener("touchmove", this._touchmoveHandler),
        e.addEventListener("touchend", this._touchendHandler)) : (e.addEventListener("click", this._clickHandler),
        ...
        e.addEventListener("mouseout", this._mouseoutHandler)) : (window.attachEvent("onresize", this._resizeHandler),
    ...
    U.prototype.dispose = function() {
        ...
        r.os.tablet || r.os.phone ? (e.removeEventListener("touchstart", this._touchstartHandler),
        e.removeEventListener("touchmove", this._touchmoveHandler),
        e.removeEventListener("touchend", this._touchendHandler)) : (e.removeEventListener("click", this._clickHandler),
        e.removeEventListener("dblclick", this._dblclickHandler),
        e.removeEventListener("mousewheel", this._mousewheelHandler),
        ...
        e.removeEventListener("DOMMouseScroll", this._mousewheelHandler),
        e.removeEventListener("mouseout", this._mouseoutHandler)) : (window.detachEvent("onresize", this._resizeHandler),
    ...
    U.prototype._processDragStart = function(e) {
        ...
        if (this._isMouseDown && t && t.draggable && !this._draggingTarget && this._mouseDownTarget == t) {
            if (t.dragEnableTime && new Date - this._lastMouseDownMoment < t.dragEnableTime)
                return;
            var i = t;
    ...
    U.prototype._processDrop = function(e) {
        ...
        this.painter.refresh(),
        this._dispatchAgency(this._lastHover, c.DROP, e, this._draggingTarget))
    }
    ,
    U.prototype._processDragEnd = function(e) {
        this._draggingTarget && (this._dispatchAgency(this._draggingTarget, c.DRAGEND, e),
        this._lastHover = null),
        this._isDragging = 0,
    ...
    U.prototype._dispatchAgency = function(e, t, i, n) {
        var a = "on" + t
          ...
          , r = e;
        for (n && (o.dragged = n); r && (r[a] && (o.cancelBubble = r[a](o)),
        r.dispatch(t, o),
        r = r.parent,
        !o.cancelBubble); )
            ;
        if (e)
            o.cancelBubble || this.dispatch(t, o);
        else if (!n) {
            var s = {
                type: t,
                event: i
    ...
    U.prototype._iterateAndFindHover = function() {
        ...
        return function() {
            for (var t, i, n = this.storage.getShapeList(), a = [0, 0], o = n.length - 1; o >= 0; o--) {
                var r = n[o];
                if (t !== r.zlevel && (i = this.painter.getLayer(r.zlevel, i),
                a[0] = this._mouseX,
                a[1] = this._mouseY,
                i.needTransform && (d.invert(e, i.transform),
                h.applyTransform(a, a, e))),
                this._findHover(r, a[0], a[1]))
                    break
            }
        }
    }();
    ...
    return U.prototype._mobileFindFixed = function(e) {
        ...
        this._lastHover && (e.zrenderX = this._mouseX,
        e.zrenderY = this._mouseY)
    }
    ,
    U.prototype._zrenderEventFixed = function(e, t) {
        ...
        if (t) {
            ...
            a && a != this._domHover && (e.zrenderX = ("undefined" != typeof e.offsetX ? e.offsetX : e.layerX) + a.offsetLeft,
            e.zrenderY = ("undefined" != typeof e.offsetY ? e.offsetY : e.layerY) + a.offsetTop)
        }
...
define("zrender/Painter", ["require", "./config", "./tool/util", "./tool/log", "./loadingEffect/Base", "./Layer", "./shape/Image"], function(e) {
    ...
    h.prototype._paintList = function(e, t) {
        ...
        for (var s = 0, l = e.length; l > s; s++) {
            var h = e[s];
            if (n !== h.zlevel && (i && (i.needTransform && o.restore(),
            o.flush && o.flush()),
            n = h.zlevel,
            i = this.getLayer(n),
            i.isBuildin || r("ZLevel " + n + " has been used by unkown layer " + i.id),
            o = i.ctx,
            i.unusedCount = 0,
            (i.dirty || t) && i.clear(),
            i.needTransform && (o.save(),
            i.setTransform(o))),
            (i.dirty || t) && !h.invisible && (!h.onbrush || h.onbrush && !h.onbrush(o, !1)))
    ...
    h.prototype.insertLayer = function(e, t) {
        if (this._layers[e])
            return void r("ZLevel " + e + " has been used already");
        if (!n(t))
            return void r("Layer of zlevel " + e + " is not valid");
    ...
    h.prototype.refreshHover = function() {
        this.clearHover();
        for (var e = this.storage.getHoverShapes(!0), t = 0, i = e.length; i > t; t++)
    ...
    h.prototype.resize = function() {
        ...
        var t = this._getWidth()
          , i = this._getHeight();
        if (e.style.display = "",
        this._width != t || i != this._height) {
            this._width = t,
            this._height = i,
            e.style.width = t + "px",
            e.style.height = i + "px";
            for (var n in this._layers)
                this._layers[n].resize(t, i);
            this.refresh(null, !0)
        }
        return this
    }
...
define("zrender/Storage", ["require", "./tool/util", "./Group"], function(e) {
    ...
    return o.prototype.iterShape = function(e, t) {
        ...
        switch (t.update && this.updateShapeList(),
        t.normal) {
        case "down":
            for (var n = this._shapeList.length; n--; )
                if (e(this._shapeList[n]))
                    return this;
            break;
        default:
            for (var i = 0, n = this._shapeList.length; n > i; i++)
                if (e(this._shapeList[i]))
                    return this
        }
        return this
    }
    ...
    o.prototype.updateShapeList = function() {
        ...
        for (var e = 0, i = this._shapeList.length; i > e; e++)
    ...
    o.prototype._updateAndAddShape = function(e, t) {
        if (!e.ignore)
            ...
            e.clipShape && (e.clipShape.parent = e,
            e.clipShape.updateTransform(),
            t ? (t = t.slice(),
            t.push(e.clipShape)) : t = [e.clipShape]),
            "group" == e.type) {
    ...
    o.prototype.mod = function(e, t) {
        if ("string" == typeof e && (e = this._elements[e]),
        e && (e.modSelf(),
        t))
            if (t.parent || t._storage || t.__clipShapes) {
                var n = {};
                for (var a in t)
                    "parent" !== a && "_storage" !== a && "__clipShapes" !== a && t.hasOwnProperty(a) && (n[a] = t[a]);
                i.merge(e, n, !0)
            } else
                i.merge(e, t, !0);
        return this
    ...
    o.prototype.drift = function(e, t, i) {
        ...
        return n && (n.needTransform = !0,
        "horizontal" === n.draggable ? i = 0 : "vertical" === n.draggable && (t = 0),
        (!n.ondrift || n.ondrift && !n.ondrift(t, i)) && n.drift(t, i)),
        this
    }
    ,
    ...
    o.prototype.addRoot = function(e) {
        this._elements[e.id] || (e instanceof n && e.addChildrenToStorage(this),
        this.addToMap(e),
        this._roots.push(e))
    }
    ,
    ...
    o.prototype.delFromMap = function(e) {
        ...
        return t && (delete this._elements[e],
        t instanceof n && (t._storage = null)),
        this
    }
    ,
...
define("zrender/animation/Animation", ["require", "./Clip", "../tool/color", "../tool/util", "../tool/event"], function(e) {
    ...
    function r(e, t, i, n, a, o, r, l, h) {
        ...
        if (1 == h)
            for (var c = 0; d > c; c++)
                l[c] = s(e[c], t[c], i[c], n[c], a, o, r);
        else
            for (var m = e[0].length, c = 0; d > c; c++)
                for (var p = 0; m > p; p++)
                    l[c][p] = s(e[c][p], t[c][p], i[c][p], n[c][p], a, o, r)
    }
    function s(e, t, i, n, a, o, r) {
        var s = .5 * (i - e)
          , l = .5 * (n - t);
    ...
    return g.prototype = {
        when: function(e, t) {
            for (var i in t)
                this._tracks[i] || (this._tracks[i] = [],
                0 !== e && this._tracks[i].push({
                    time: 0,
        ...
        start: function(e) {
            var t = this
              ...
              , p = function() {
                ...
                0 === t._clipCount) {
                    t._tracks = {};
                    for (var e = t._doneList.length, i = 0; e > i; i++)
                        t._doneList[i].call(t)
                }
            }
              , u = function(u, V) {
                var U = u.length;
                if (U) {
                    ...
                    if (U) {
                        ...
                        for (var x = [], k = [], v = 0; U > v; v++) {
                            x.push(u[v].time / _);
                            var L = u[v].value;
                            "string" == typeof L && (L = c.toArray(L),
                            0 === L.length && (L[0] = L[1] = L[2] = 0,
                            L[3] = 1),
                            y = !0),
                            k.push(L)
                        }
                        var w, v, W, X, I, S, K, C = 0, T = 0;
                        if (y)
                            var E = [0, 0, 0, 0];
                        var z = function(e, o) {
                            if (T > o) {
                                for (w = Math.min(C + 1, U - 1),
                                v = w; v >= 0 && !(x[v] <= o); v--)
                                    ;
                                v = Math.min(v, U - 2)
                            } else {
                            ...
                            if (0 !== d) {
                                ...
                                m)
                                    ...
                                    K = k[v > U - 3 ? U - 1 : v + 2],
                                    f)
                                        r(X, I, S, K, W, W * W, W * W * W, l(e, V), b);
                                    else {
                                        var c;
                                        y ? (c = r(X, I, S, K, W, W * W, W * W * W, E, 1),
                                        c = h(E)) : c = s(X, I, S, K, W, W * W, W * W * W),
                                        i(e, V, c)
                                    }
                                else if (f)
                                    a(k[v], k[v + 1], W, l(e, V), b);
                                else {
                                    var c;
                                    y ? (a(k[v], k[v + 1], W, E, 1),
                                    c = h(E)) : c = n(k[v], k[v + 1], W),
                                    i(e, V, c)
                                }
                                for (v = 0; v < t._onframeList.length; v++)
                                    t._onframeList[v](e, o);
...
define("zrender/Layer", ["require", "./mixin/Transformable", "./tool/util", "./config"], function(e) {
    ...
    s.prototype.resize = function(e, t) {
        ...
        this.domBack && (this.domBack.setAttribute("width", e * i),
        this.domBack.setAttribute("height", t * i),
    ...
    s.prototype.clear = function() {
        ...
        if (s && (this.domBack || this.createBackBuffer(),
        this.ctxBack.globalCompositeOperation = "copy",
        this.ctxBack.drawImage(e, 0, 0, i / h, n / h)),
        t.clearRect(0, 0, i / h, n / h),
        a && (t.save(),
        t.fillStyle = this.clearColor,
        t.fillRect(0, 0, i / h, n / h),
        t.restore()),
        s) {
            var d = this.domBack;
            t.save(),
...
define("zrender/shape/Text", ["require", "../tool/area", "./Base", "../tool/util"], function(e) {
    ...
    return n.prototype = {
        ...
        brush: function(e, i) {
            var n = this.style;
            if (i && (n = this.getHighlightStyle(n, this.highlightStyle || {})),
            "undefined" != typeof n.text && n.text !== !1) {
                e.save(),
                this.doClip(e),
                this.setContext(e, n),
                this.setTransform(e),
...
define("zrender/shape/Rectangle", ["require", "./Base", "../tool/util"], function(e) {
    ...
    return i.prototype = {
        ...
        _buildRadiusPath: function(e, t) {
            ...
            "number" == typeof d ? i = n = a = o = d : d instanceof Array ? 1 === d.length ? i = n = a = o = d[0] : 2 === d.length ? (i = a = d[0],
            n = o = d[1]) : 3 === d.length ? (i = d[0],
            n = o = d[1],
            a = d[2]) : (i = d[0],
            n = d[1],
            a = d[2],
        ...
        buildPath: function(e, t) {
            t.radius ? this._buildRadiusPath(e, t) : (e.moveTo(t.x, t.y),
...
define("zrender/tool/area", ["require", "./util", "./curve"], function(e) {
    ...
    function i(e, t, i, o) {
        ...
        if ("undefined" != typeof s)
            return s;
        if (e.buildPath && v.isPointInPath)
            return a(e, v, t, i, o);
        switch (r) {
        case "ellipse":
            return !0;
    ...
    function r(e, t, i, n, a, o, r) {
        ...
        var s = Math.max(a, 5)
          , l = 0
          , h = e;
        if (r > t + s && r > n + s || t - s > r && n - s > r || o > e + s && o > i + s || e - s > o && i - s > o)
            return !1;
        if (e === i)
    ...
    function s(e, t, i, n, a, o, r, s, l, h, d) {
        if (0 === l)
            return !1;
        var c = Math.max(l, 5);
        if (d > t + c && d > n + c && d > o + c && d > s + c || t - c > d && n - c > d && o - c > d && s - c > d || h > e + c && h > i + c && h > a + c && h > r + c || e - c > h && i - c > h && a - c > h && r - c > h)
            return !1;
    ...
    function l(e, t, i, n, a, o, r, s, l) {
        if (0 === r)
            return !1;
        var h = Math.max(r, 5);
        if (l > t + h && l > n + h && l > o + h || t - h > l && n - h > l && o - h > l || s > e + h && s > i + h && s > a + h || e - h > s && i - h > s && a - h > s)
            return !1;
    ...
    function f(e, t, i, n, a, o, r, s, l, h) {
        if (h > t && h > n && h > o && h > s || t > h && n > h && o > h && s > h)
            return 0;
        ...
        for (var c, m, p = 0, u = -1, V = 0; d > V; V++) {
            ...
            l > f || (0 > u && (u = w.cubicExtrema(t, n, o, s, E),
            E[1] < E[0] && u > 1 && g(),
            c = w.cubicAt(t, n, o, s, E[0]),
            u > 1 && (m = w.cubicAt(t, n, o, s, E[1]))),
            p += 2 == u ? U < E[0] ? t > c ? 1 : -1 : U < E[1] ? c > m ? 1 : -1 : m > s ? 1 : -1 : U < E[0] ? t > c ? 1 : -1 : c > s ? 1 : -1)
        }
        return p
    }
    function y(e, t, i, n, a, o, r, s) {
        if (s > t && s > n && s > o || t > s && n > s && o > s)
            return 0;
        ...
        for (var c = 0, m = 0; 2 > m; m++) {
            ...
            if (p + e > s) {
                var u = Math.atan2(l, p)
                  , d = r ? 1 : -1;
                0 > u && (u = C + u),
                (u >= a && o >= u || u + C >= a && o >= u + C) && (u > Math.PI / 2 && u < 1.5 * Math.PI && (d = -d),
                c += d)
            }
        }
        return c
    ...
    function _(e, t, i, n, a) {
        ...
        for (var g = "stroke" === i || "both" === i, _ = "fill" === i || "both" === i, x = 0; x < e.length; x++) {
            ...
            case "L":
                ...
                break;
            case "C":
                if (g && s(d, c, v[0], v[1], v[2], v[3], v[4], v[5], t, n, a))
                    return !0;
                ...
                break;
            case "Q":
                if (g && l(d, c, v[0], v[1], v[2], v[3], t, n, a))
                    return !0;
            ...
            case "A":
                ...
                p = C) : o += U(d, c, K, C);
                var T = (n - L) * X / W + L;
                if (g && h(L, w, X, I, I + S, 1 - v[7], t, T, a))
                    return !0;
    ...
    function x(e, t) {
        ...
        t && (v.font = t),
        e = (e + "").split("\n");
        for (var n = 0, a = 0, o = e.length; o > a; a++)
            n = Math.max(v.measureText(e[a]).width, n);
        return v.restore(),
        W[i] = n,
        ++I > K && (I = 0,
        W = {}),
    ...
    var v, L = e("./util"), w = e("./curve"), W = {}, X = {}, I = 0, S = 0, K = 5e3, C = 2 * Math.PI, T = [-1, -1, -1], E = [-1, -1];
    return {
        isInside: i,
        isOutside: o,
        getTextWidth: x,
...
define("zrender/shape/Base", ["require", "../tool/matrix", "../tool/guid", "../tool/util", "../tool/log", "../mixin/Transformable", "../mixin/Eventful", "../tool/area", "../tool/color"], function(e) {
    ...
    d.prototype.beforeBrush = function(e, t) {
        ...
        t && (i = this.getHighlightStyle(i, this.highlightStyle || {}, this.brushTypeOnly)),
    ...
    d.prototype.getHighlightStyle = function(t, i, n) {
        ...
        "stroke" != t.brushType ? (a.strokeColor = s,
        a.lineWidth = (t.lineWidth || 1) + this.getHighlightZoom(),
        a.brushType = "both") : "stroke" != n ? (a.strokeColor = s,
        a.lineWidth = (t.lineWidth || 1) + this.getHighlightZoom()) : a.strokeColor = i.strokeColor || r.mix(t.strokeColor, r.toRGB(s));
        for (var o in i)
            "undefined" != typeof i[o] && (a[o] = i[o]);
        return a
    }
    ,
    ...
    d.prototype.drawText = function(e, i, n) {
        if ("undefined" != typeof i.text && i.text !== !1) {
            ...
            case "end":
                ...
                f >= 30 && 150 >= f ? (o = "center",
                r = "bottom",
                l -= h) : f > 150 && 210 > f ? (o = "right",
                r = "middle",
                s -= h) : f >= 210 && 330 >= f ? (o = "center",
                r = "top",
                l += h) : (o = "left",
                r = "middle",
                s += h);
...
define("zrender/mixin/Transformable", ["require", "../tool/matrix", "../tool/vector"], function(e) {
    ...
    return l.prototype = {
        ...
        updateTransform: function() {
            ...
            if (this.needTransform = this.needLocalTransform || e,
            this.needTransform) {
                ...
                this.needLocalTransform) {
                    ...
                    if (this.rotation instanceof Array) {
                        ...
                        0 !== this.rotation && n.rotate(t, t, this.rotation);
...
define("zrender/Group", ["require", "./tool/guid", "./tool/util", "./mixin/Transformable", "./mixin/Eventful"], function(e) {
    ...
    o.prototype.addChild = function(e) {
        e != this && e.parent != this && (e.parent && e.parent.removeChild(e),
        this._children.push(e),
        e.parent = this,
        this._storage && this._storage !== e._storage && (this._storage.addToMap(e),
    ...
    o.prototype.removeChild = function(e) {
        ...
        e.parent = null,
        this._storage && (this._storage.delFromMap(e.id),
    ...
    o.prototype.clearChildren = function() {
        for (var e = 0; e < this._children.length; e++) {
            ...
            this._storage && (this._storage.delFromMap(t.id),
...
define("zrender/animation/Clip", ["require", "./easing"], function(e) {
    ...
    return t.prototype = {
        ...
        fire: function(e, t) {
            for (var i = 0, n = this._targetPool.length; n > i; i++)
                this["on" + e] && this["on" + e](this._targetPool[i], t)
        },
        constructor: t
    },
    t
...
define("zrender/animation/easing", [], function() {
    var e = {
        ...
        ElasticInOut: function(e) {
            ...
            return 0 === e ? 0 : 1 === e ? 1 : (!i || 1 > i ? (i = 1,
            t = n / 4) : t = n * Math.asin(1 / i) / (2 * Math.PI),
            (e *= 2) < 1 ? -.5 * i * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * (e - t) * Math.PI / n) : i * Math.pow(2, -10 * (e -= 1)) * Math.sin(2 * (e - t) * Math.PI / n) * .5 + 1)
        },
        BackIn: function(e) {
            var t = 1.70158;
            return e * e * ((t + 1) * e - t)
    ...
    return i.prototype = {
        ...
        ondrop: function(e, t) {
            if (this.isDrop && e.target && !t.dragIn) {
                var i, n = e.target, a = e.dragged, o = d.get(n, "seriesIndex"), r = d.get(n, "dataIndex"), s = this.series, l = this.component.legend;
                if (-1 === r) {
                    if (d.get(a, "seriesIndex") == o)
                        return t.dragOut = t.dragIn = t.needRefresh = !0,
                        void (this.isDrop = !1);
                    i = {
                        value: d.get(a, "value"),
                        name: d.get(a, "name")
                    ...
                    for (var c = !1, m = s[o].data, u = 0, V = m.length; V > u; u++)
                        m[u].name === i.name && "-" === m[u].value && (s[o].data[u].value = i.value,
                        c = !0);
                    !c && s[o].data.push(i),
                    l && l.add(i.name, a.style.color || a.style.strokeColor)
                } else
                    i = s[o].data[r] || "-",
                    null != i.value ? (s[o].data[r].value = "-" != i.value ? p.accAdd(s[o].data[r].value, d.get(a, "value")) : d.get(a, "value"),
                    (this.type === h.CHART_TYPE_FUNNEL || this.type === h.CHART_TYPE_PIE) && (l && 1 === l.getRelatedAmount(i.name) && this.component.legend.del(i.name),
                    i.name += this.option.nameConnector + d.get(a, "name"),
                    l && l.add(i.name, a.style.color || a.style.strokeColor))) : s[o].data[r] = "-" != i ? p.accAdd(s[o].data[r], d.get(a, "value")) : d.get(a, "value");
                t.dragIn = t.dragIn || !0,
                this.isDrop = !1;
                var U = this;
                setTimeout(function() {
        ...
        onlegendSelected: function(e, t) {
            var i = e.selected;
            for (var n in this.selectedMap)
                this.selectedMap[n] != i[n] && (t.needRefresh = !0),
        ...
        _buildPosition: function() {
            ...
            for (var e, t, i, n, a = this.series, o = {
                ...
                right: [],
                other: []
            }, r = 0, s = a.length; s > r; r++)
                a[r].type === this.type && (a[r] = this.reformOption(a[r]),
                this.legendHoverLink = a[r].legendHoverLink || this.legendHoverLink,
                e = a[r].xAxisIndex,
                t = a[r].yAxisIndex,
                i = this.component.xAxis.getAxis(e),
                n = this.component.yAxis.getAxis(t),
                i.type === h.COMPONENT_TYPE_AXIS_CATEGORY ? o[i.getPosition()].push(r) : n.type === h.COMPONENT_TYPE_AXIS_CATEGORY ? o[n.getPosition()].push(r) : o.other.push(r));
            for (var l in o)
                o[l].length > 0 && this._buildSinglePosition(l, o[l]);
            this.addShapeList()
        },
        ...
        _mapData: function(e) {
            for (var t, i, n, a, o = this.series, r = 0, s = {}, l = "__kener__stack__", d = this.component.legend, c = [], m = 0, p = 0, u = e.length; u > p; p++) {
                if (t = o[e[p]],
                n = t.name,
                this._sIndex2ShapeMap[e[p]] = this._sIndex2ShapeMap[e[p]] || this.query(t, "symbol") || this._symbol[p % this._symbol.length],
                d) {
                    if (this.selectedMap[n] = d.isSelected(n),
                    this._sIndex2ColorMap[e[p]] = d.getColor(n),
                    a = d.getItemShape(n)) {
                        var V = a.style;
                        if (this.type == h.CHART_TYPE_LINE)
                            V.iconType = "legendLineIcon",
                ...
                this.selectedMap[n] && (i = t.stack || l + e[p],
                null == s[i] ? (s[i] = r,
                c[r] = [e[p]],
                r++) : c[s[i]].push(e[p])),
        ...
        buildMark: function(e) {
            var t = this.series[e];
            this.selectedMap[t.name] && (t.markLine && this._buildMarkLine(e),
            t.markPoint && this._buildMarkPoint(e))
        },
        _buildMarkPoint: function(e) {
            for (var t, i, n = (this.markAttachStyle || {})[e], a = this.series[e], o = U.clone(a.markPoint), r = 0, s = o.data.length; s > r; r++)
                t = o.data[r],
                i = this.getMarkCoord(e, t),
                t.x = null != t.x ? t.x : i[0],
                t.y = null != t.y ? t.y : i[1],
                !t.type || "max" !== t.type && "min" !== t.type || (t.value = i[3],
                t.name = t.name || t.type,
                t.symbolSize = t.symbolSize || g.getTextWidth(i[3], this.getFont()) / 2 + 5);
        ...
        _buildMarkLine: function(e) {
            for (var t, i = (this.markAttachStyle || {})[e], n = this.series[e], a = U.clone(n.markLine), o = 0, r = a.data.length; r > o; o++) {
                var s = a.data[o];
                !s.type || "max" !== s.type && "min" !== s.type && "average" !== s.type ? t = [this.getMarkCoord(e, s[0]), this.getMarkCoord(e, s[1])] : (t = this.getMarkCoord(e, s),
                a.data[o] = [U.clone(s), {}],
                a.data[o][0].name = s.name || s.type,
                a.data[o][0].value = "average" !== s.type ? t[3] : +t[3].toFixed(null != a.precision ? a.precision : this.deepQuery([this.ecTheme, h], "markLine.precision")),
                t = t[2],
                s = [{}, {}]),
                null != t && null != t[0] && null != t[1] && (a.data[o][0].x = null != s[0].x ? s[0].x : t[0][0],
                a.data[o][0].y = null != s[0].y ? s[0].y : t[0][1],
                a.data[o][1].x = null != s[1].x ? s[1].x : t[1][0],
                a.data[o][1].y = null != s[1].y ? s[1].y : t[1][1])
            }
            ...
            if (c) {
                ...
                if (p) {
                    ...
                    U.merge(m.highlightStyle = {}, p.highlightStyle),
        ...
        _markPoint: function(e, t) {
            ...
            t.name = i.name;
            var a, o, r, s, l, c, m, p = [], u = t.data, V = n.dataRange, g = n.legend, f = this.zr.getWidth(), y = this.zr.getHeight();
            if (t.large)
                a = this.getLargeMarkPointShape(e, t),
                a._mark = "largePoint",
                a && p.push(a);
            else
                for (var b = 0, _ = u.length; _ > b; b++)
                    null != u[b].x && null != u[b].y && (r = null != u[b].value ? u[b].value : "",
                    g && (o = g.getColor(i.name)),
                    V && (o = isNaN(r) ? o : V.getColor(r),
                    s = [u[b], t],
                    l = this.deepQuery(s, "itemStyle.normal.color") || o,
                    c = this.deepQuery(s, "itemStyle.emphasis.color") || l,
                    null == l && null == c) || (o = null == o ? this.zr.getColor(e) : o,
                    u[b].tooltip = u[b].tooltip || t.tooltip || {
                        trigger: "item"
                    },
                    u[b].name = null != u[b].name ? u[b].name : "",
                    u[b].value = r,
                    a = this.getSymbolShape(t, e, u[b], b, u[b].name, this.parsePercent(u[b].x, f), this.parsePercent(u[b].y, y), "pin", o, "rgba(0,0,0,0)", "horizontal"),
                    a._mark = "point",
                    m = this.deepMerge([u[b], t], "effect"),
                    m.show && (a.effect = m),
                    i.type === h.CHART_TYPE_MAP && (a._geo = this.getMarkGeo(u[b])),
                    d.pack(a, i, e, u[b], b, u[b].name, r),
                    p.push(a)));
            return p
        },
        _markLine: function() {
        ...
        getSymbolShape: function(e, t, i, o, r, s, l, h, c, m, p) {
            ...
            return h.match("image") && (w.style.image = h.replace(new RegExp("^image:\\/\\/"), ""),
            w = new n({
                style: w.style,
            ...
            h.match("star") && (w.style.iconType = "star",
            w.style.n = h.replace("empty", "").replace("star", "") - 0 || 5),
            "none" === h && (w.invisible = !0,
            w.hoverable = !1),
            w = this.addLabel(w, e, i, r, p),
            h.match("empty") && (null == w.style.textColor && (w.style.textColor = w.style.strokeColor),
            null == w.highlightStyle.textColor && (w.highlightStyle.textColor = w.highlightStyle.strokeColor)),
            d.pack(w, e, t, i, o, r),
            w._x = s,
            w._y = l,
            w._dataIndex = o,
        ...
        getMarkLineShape: function(e, t, i, n, a, r, l) {
            ...
            var x = r ? s : o
              ...
              , v = k.style;
            return r ? (v.pointList = a,
            v.smooth = _) : (v.xStart = a[0][0],
            v.yStart = a[0][1],
            v.xEnd = a[1][0],
            v.yEnd = a[1][1],
            v.curveness = _,
            k.updatePoints(k.style)),
            k = this.addLabel(k, e, i[0], i[0].name + " : " + i[1].name)
        },
        getLargeMarkPointShape: function(e, t) {
            var i, n, a, o, s, l, h = this.series[e], d = this.component, c = t.data, m = d.dataRange, p = d.legend, u = [c[0], t];
            if (p && (n = p.getColor(h.name)),
            !m || (a = null != c[0].value ? c[0].value : "",
            n = isNaN(a) ? n : m.getColor(a),
            o = this.deepQuery(u, "itemStyle.normal.color") || n,
            s = this.deepQuery(u, "itemStyle.emphasis.color") || o,
            null != o || null != s)) {
        ...
        addShapeList: function() {
            var e, t, i = this.option.animationThreshold / (this.canvasSupported ? 2 : 4), n = this.lastShapeList, a = this.shapeList, o = n.length > 0, r = o ? this.query(this.option, "animationDurationUpdate") : this.query(this.option, "animationDuration"), s = this.query(this.option, "animationEasing"), l = {}, d = {};
            if (this.option.animation && !this.option.renderAsImage && a.length < i && !this.motionlessOnce) {
                for (var c = 0, m = n.length; m > c; c++)
                    t = this._getAnimationKey(n[c]),
                    t.match("undefined") ? this.zr.delShape(n[c].id) : (t += n[c].type,
                    l[t] ? this.zr.delShape(n[c].id) : l[t] = n[c]);
                for (var c = 0, m = a.length; m > c; c++)
                    t = this._getAnimationKey(a[c]),
                    t.match("undefined") ? this.zr.addShape(a[c]) : (t += a[c].type,
                    d[t] = a[c]);
                for (t in l)
                    d[t] || this.zr.delShape(l[t].id);
                for (t in d)
                    l[t] ? (this.zr.delShape(l[t].id),
                    this._animateMod(l[t], d[t], r, s, 0, o)) : (e = this.type != h.CHART_TYPE_LINE && this.type != h.CHART_TYPE_RADAR || 0 === t.indexOf("icon") ? 0 : r / 2,
                    this._animateMod(!1, d[t], r, s, e, o));
                this.zr.refresh(),
        ...
        animationMark: function(e, t, i) {
            for (var i = i || this.shapeList, n = 0, a = i.length; a > n; n++)
                i[n]._mark && this._animateMod(!1, i[n], e, t, 0, !0);
            this.animationEffect(i)
        },
        animationEffect: function(e) {
            if (!e && this.clearEffectShape(),
            e = e || this.shapeList,
            null != e) {
                ...
                for (var i, n = 0, a = e.length; a > n; n++)
                    i = e[n],
                    i._mark && i.effect && i.effect.show && m[i._mark] && (m[i._mark](this.zr, this.effectList, i, t),
                    this.effectList[this.effectList.length - 1]._mark = i._mark)
            }
        },
        clearEffectShape: function(e) {
            ...
            if (this.zr && t && t.length > 0) {
                ...
                for (var i = 0; i < t.length; i++)
                    t[i].effectAnimator && t[i].effectAnimator.stop()
            }
            this.effectList = []
        },
        addMark: function(e, t, i) {
            ...
            if (this.selectedMap[n.name]) {
                ...
                if (n[i].data = t.data,
                this["_build" + i.replace("m", "M")](e),
                this.option.animation && !this.option.renderAsImage)
                    this.animationMark(a, o, this.shapeList.slice(s));
                else {
                    for (var l = s, h = this.shapeList.length; h > l; l++)
...
define("echarts/util/shape/Icon", ["require", "zrender/tool/util", "zrender/shape/Star", "zrender/shape/Heart", "zrender/shape/Droplet", "zrender/shape/Image", "zrender/shape/Base"], function(e) {
    ...
    function p(e, t) {
        for (var i = t.x, n = t.y, a = t.width, o = t.height, r = Math.round(o / 3), s = Math.round((r - 2) / 2), l = 3; l--; )
            e.rect(i, n + r * l + s, a, 2)
    }
    function u(e, t) {
        for (var i = t.x, n = t.y, a = t.width, o = t.height, r = Math.round(a / 3), s = Math.round((r - 2) / 2), l = 3; l--; )
            e.rect(i + r * l + s, n, 2, o)
    }
    function V(e, t) {
        var i = t.x
          , n = t.y
    ...
    return X.prototype = {
        ...
        buildPath: function(e, t, i) {
            this.iconLibrary[t.iconType] ? this.iconLibrary[t.iconType].call(this, e, t, i) : (e.moveTo(t.x, t.y),
            e.lineTo(t.x + t.width, t.y),
            e.lineTo(t.x + t.width, t.y + t.height),
            e.lineTo(t.x, t.y + t.height),
            e.lineTo(t.x, t.y),
        ...
        buildPath: function(e, t) {
            ...
            if (0 !== n)
                for (var a, o, r, s, l, h = 1e4, d = Math.ceil(n / h), c = i[0]instanceof Array, m = t.size ? t.size : 2, p = m, u = m / 2, V = 2 * Math.PI, U = 0; d > U; U++) {
                    ...
                    o = o > n ? n : o;
                    for (var g = a; o > g; g++)
                        if (t.random && (r = t["randomMap" + g % 20] / 100,
                        p = m * r * r,
                        u = p / 2),
                        c ? (s = i[g][0],
                        l = i[g][1]) : (s = i[g].x,
        ...
        buildPath: function(e, t) {
            ...
            if (!(n.length < 2)) {
                ...
                if (t.smooth && "spline" !== t.smooth) {
                    ...
                    for (var s, l, h, d = 0; o - 1 > d; d++)
                        s = r[2 * d],
                        l = r[2 * d + 1],
                        h = n[d + 1],
                        e.bezierCurveTo(s[0], s[1], l[0], l[1], h[0], h[1])
                } else if ("spline" === t.smooth && (n = i(n),
                o = n.length),
                t.lineType && "solid" != t.lineType) {
                    if ("dashed" == t.lineType || "dotted" == t.lineType) {
                        ...
                        e.moveTo(n[0][0], n[0][1]);
                        for (var d = 1; o > d; d++)
                            a(e, n[d - 1][0], n[d - 1][1], n[d][0], n[d][1], c)
                    }
                } else {
                    e.moveTo(n[0][0], n[0][1]);
                    for (var d = 1; o > d; d++)
    ...
    return i.prototype = {
        ...
        brush: function(e, t) {
            ...
            for (var n = 0; n < i.shapeList.length; n++) {
                var a = i.shapeList[n]
                  , o = a.style;
                t && (o = a.getHighlightStyle(o, a.highlightStyle || {}, a.brushTypeOnly)),
                a.buildPath(e, o)
            }
            switch (i.brushType) {
            case "both":
        ...
        getRect: function(e) {
            if (e.__rect)
                return e.__rect;
            for (var t = 1 / 0, i = -(1 / 0), n = 1 / 0, a = -(1 / 0), o = 0; o < e.shapeList.length; o++)
                var r = e.shapeList[o]
                  , s = r.getRect(r.style)
                  , t = Math.min(s.x, t)
                  , n = Math.min(s.y, n)
...
define("echarts/util/ecAnimation", ["require", "zrender/tool/util", "zrender/tool/curve", "zrender/shape/Polygon"], function(e) {
    function t(e, t, i, n, a) {
        ...
        if (!t) {
            if (o = [],
            "vertical" != i._orient)
                for (var l = r[0][1], h = 0; s > h; h++)
                    o[h] = [r[h][0], l];
            else
                for (var d = r[0][0], h = 0; s > h; h++)
                    o[h] = [d, r[h][1]];
            "half-smooth-polygon" == i.type && (o[s - 1] = u.clone(r[s - 1]),
            o[s - 2] = u.clone(r[s - 2])),
            t = {
                style: {
                    pointList: o
    ...
    function o(e, t, i, n, a) {
        var o = i.style.x
          ...
          , l = i.style.r;
        i.__animating = !0,
        "r" != i._animationAdd ? (i.style.r0 = 0,
        i.style.r = 0,
        i.rotation = [2 * Math.PI, o, r],
        e.addShape(i),
        e.animate(i.id, "style").when(n, {
            r0: s,
            r: l
        ...
        e.animate(i.id, "").when(n, {
            rotation: [0, o, r]
        }).start(a)) : (i.style.r0 = i.style.r,
        e.addShape(i),
        e.animate(i.id, "style").when(n, {
            r0: s
        }).done(function() {
...
define("echarts/util/ecEffect", ["require", "../util/ecData", "zrender/shape/Circle", "zrender/shape/Image", "zrender/tool/curve", "../util/shape/Icon", "../util/shape/Symbol", "zrender/shape/ShapeBundle", "zrender/shape/Polyline", "zrender/tool/vector", "zrender/tool/env"], function(e) {
    function t(e, t, i, n) {
        var a, r = i.effect, l = r.color || i.style.strokeColor || i.style.color, d = r.shadowColor || l, c = r.scaleSize, m = r.bounceDistance, p = "undefined" != typeof r.shadowBlur ? r.shadowBlur : c;
        ...
        "pin" == i.style.iconType && (a.style.y += a.style.height / 2 * 1.5),
        u && (a.style.image = e.shapeToImage(a, a.style.width + 2 * p + 2, a.style.height + 2 * p + 2).style.image,
        a = new s({
            zlevel: a.zlevel,
            style: a.style,
            draggable: !1,
    ...
    function i(e, t, i, n) {
        ...
        for (var m = Math.round(100 * a.period), p = {}, u = {}, V = 0; 20 > V; V++)
            c.style["randomMap" + V] = 0,
            p = {},
            p["randomMap" + V] = 100,
            u = {},
            u["randomMap" + V] = 0,
    ...
    function n(e, t, i, n, a) {
        ...
        if (i instanceof m) {
            ...
            if (i.style.curveness > 0) {
                ...
                g.effectAnimator = e.animation.animate(g.style, {
                    loop: s.loop
                }).when(E, {
                    x: K,
                    y: C
    ...
    function a(e, t, i, a) {
        ...
        for (var l = 0, h = [], d = 0; d < r.length; d++) {
            ...
            0 === d && (o.style.color = m.style.color,
            o.style.shadowBlur = m.style.shadowBlur,
            o.style.shadowColor = m.style.shadowColor),
            h.push(p)
        }
        t.push(o),
        e.addShape(o);
...
define("echarts/component/base", ["require", "../config", "../util/ecData", "../util/ecQuery", "../util/number", "zrender/tool/util", "zrender/tool/env"], function(e) {
    function t(e, t, a, o, r) {
        ...
        s._onlegendhoverlink = function(e) {
            if (s.legendHoverLink)
                for (var t, a = e.target, o = s.shapeList.length - 1; o >= 0; o--)
                    t = s.type == i.CHART_TYPE_PIE || s.type == i.CHART_TYPE_FUNNEL ? n.get(s.shapeList[o], "name") : (n.get(s.shapeList[o], "series") || {}).name,
    ...
    return t.prototype = {
        ...
        _getZ: function(e) {
            ...
            return t && null != t[e] ? t[e] : (t = i[this.type],
            t && null != t[e] ? t[e] : 0)
        },
        ...
        reformOption: function(e) {
            return e = r.merge(r.merge(e || {}, r.clone(this.ecTheme[this.type] || {})), r.clone(i[this.type] || {})),
            this.z = e.z,
        ...
        getShapeById: function(e) {
            for (var t = 0, i = this.shapeList.length; i > t; t++)
                if (this.shapeList[t].id === e)
                    return this.shapeList[t];
            return null
        },
        getFont: function(e) {
...
define("echarts/layout/EdgeBundling", ["require", "../data/KDTree", "zrender/tool/vector"], function(e) {
    ...
    function n(e) {
        var t = e.points;
        t[0][1] < t[1][1] || e instanceof i ? (this.array = [t[0][0], t[0][1], t[1][0], t[1][1]],
        this._startPoint = t[0],
        this._endPoint = t[1]) : (this.array = [t[1][0], t[1][1], t[0][0], t[0][1]],
        this._startPoint = t[1],
        this._endPoint = t[0]),
        this.ink = d(t[0], t[1]),
        this.edge = e,
        this.group = null
    ...
    o.prototype = {
        ...
        run: function(e) {
            ...
            function n(e, i) {
                for (var n = [], a = 0, o = 0; o < e.length; o++)
                    a > 0 && t(e[o], n[a - 1]) || (n[a++] = m(e[o]));
                return i[0] && !t(n[0], i[0]) && (n = n.reverse()),
                n
            }
            for (var a = this._iterate(e), o = 0; o++ < this.maxIteration; ) {
                for (var r = [], s = 0; s < a.groups.length; s++)
                    r.push(new i(a.groups[s]));
              ...
              , c = function(e, t) {
                for (var a, o = 0; o < e.length; o++) {
                    ...
                    if (r.edgeList[0] && r.edgeList[0].edge instanceof i) {
                        for (var s = [], l = 0; l < r.edgeList.length; l++)
                            s.push(r.edgeList[l].edge.group);
                        a = t ? t.slice() : [],
                        a.unshift(r.mp0),
                        a.push(r.mp1),
                        c(s, a)
            ...
            for (var m = new r(i,4), p = [], u = l(), V = l(), U = 0, g = l(), f = l(), y = 0, h = 0; h < i.length; h++) {
                ...
                if (!d.group) {
                    ...
                    for (var b = 0, _ = null, x = null, k = 0; k < p.length; k++) {
                        var v = p[k]
                          , L = 0;
                        v.group ? v.group !== x && (x = v.group,
                        U = this._calculateGroupEdgeInk(v.group, d, u, V),
                        L = v.group.ink + d.ink - U) : (U = this._calculateEdgeEdgeInk(d, v, u, V),
                        L = v.ink + d.ink - U),
                        L > b && (b = L,
                        _ = v,
                        c(f, V),
        ...
        _calculateGroupEdgeInk: function(e, t, i, n) {
            ...
            for (var l = d(i, n), r = 0; r < a.length; r++)
                l += d(a[r], i) + d(o[r], n);
            return l
        },
...
define("zrender/shape/Heart", ["require", "./Base", "./util/PathProxy", "../tool/area", "../tool/util"], function(e) {
    ...
    return a.prototype = {
        ...
        getRect: function(e) {
            return e.__rect ? e.__rect : (this._pathProxy.isEmpty() || this.buildPath(null, e),
    ...
    return i.prototype = {
        ...
        getRect: function(e) {
            ...
            var t = Math.min(e.xStart, e.xEnd, e.cpX1)
              ...
              , o = e.cpX2
              , r = e.cpY2;
            "undefined" != typeof o && "undefined" != typeof r && (t = Math.min(t, o),
            i = Math.min(i, r),
            n = Math.max(n, o),
            a = Math.max(a, r));
            var s = e.lineWidth || 1;
...
define("zrender/shape/util/dashedLineTo", [], function() {
    ...
    return function(t, i, n, a, o, r) {
        ...
        s /= h,
        l /= h;
        for (var d = !0, c = 0; h > c; ++c)
            d ? t.moveTo(i, n) : t.lineTo(i, n),
            d = !d,
            i += s,
            n += l;
        t.lineTo(a, o)
...
define("zrender/shape/Polygon", ["require", "./Base", "./util/smoothSpline", "./util/smoothBezier", "./util/dashedLineTo", "../tool/util"], function(e) {
    ...
    return o.prototype = {
        ...
        buildPath: function(e, t) {
            ...
            if (!(o.length < 2)) {
                if (t.smooth && "spline" !== t.smooth) {
                    ...
                    for (var s, l, h, d = o.length, c = 0; d > c; c++)
                        s = r[2 * c],
                        l = r[2 * c + 1],
                        h = o[(c + 1) % d],
                        e.bezierCurveTo(s[0], s[1], l[0], l[1], h[0], h[1])
                } else if ("spline" === t.smooth && (o = i(o, !0)),
                t.lineType && "solid" != t.lineType) {
                    if ("dashed" == t.lineType || "dotted" == t.lineType) {
                        var m = t._dashLength || (t.lineWidth || 1) * ("dashed" == t.lineType ? 5 : 1);
                        t._dashLength = m,
                        e.moveTo(o[0][0], o[0][1]);
                        for (var c = 1, p = o.length; p > c; c++)
                            a(e, o[c - 1][0], o[c - 1][1], o[c][0], o[c][1], m);
                        a(e, o[o.length - 1][0], o[o.length - 1][1], o[0][0], o[0][1], m)
                    }
                } else {
                    e.moveTo(o[0][0], o[0][1]);
                    for (var c = 1, p = o.length; p > c; c++)
                        e.lineTo(o[c][0], o[c][1]);
        ...
        getRect: function(e) {
            if (e.__rect)
                return e.__rect;
            for (var t = Number.MAX_VALUE, i = Number.MIN_VALUE, n = Number.MAX_VALUE, a = Number.MIN_VALUE, o = e.pointList, r = 0, s = o.length; s > r; r++)
                o[r][0] < t && (t = o[r][0]),
                o[r][0] > i && (i = o[r][0]),
                o[r][1] < n && (n = o[r][1]),
                o[r][1] > a && (a = o[r][1]);
...
define("zrender/shape/util/smoothSpline", ["require", "../../tool/vector"], function(e) {
    ...
    var i = e("../../tool/vector");
    return function(e, n) {
        for (var a = e.length, o = [], r = 0, s = 1; a > s; s++)
            r += i.distance(e[s - 1], e[s]);
        var l = r / 5;
        l = a > l ? a : l;
        for (var s = 0; l > s; s++) {
            var h, d, c, m = s / (l - 1) * (n ? a : a - 1), p = Math.floor(m), u = m - p, V = e[p % a];
            n ? (h = e[(p - 1 + a) % a],
            d = e[(p + 1) % a],
            c = e[(p + 2) % a]) : (h = e[0 === p ? p : p - 1],
            d = e[p > a - 2 ? a - 1 : p + 1],
            c = e[p > a - 3 ? a - 1 : p + 2]);
            var U = u * u
              , g = u * U;
...
define("echarts/util/number", [], function() {
    ...
    function a(e) {
        return isNaN(e) ? "-" : (e = (e + "").split("."),
        e[0].replace(/(\d{1,3})(?=(?:\d{3})+(?!\d))/g, "$1,") + (e.length > 1 ? "." + e[1] : ""))
    }
    function o(e) {
...
define("echarts/data/KDTree", ["require", "./quickSelect"], function(e) {
    ...
    var i = e("./quickSelect")
      , n = function(e, t) {
        e.length && (t || (t = e[0].array.length),
        this.dimension = t,
        this.root = this._buildTree(e, 0, e.length - 1, 0),
        this._stack = [],
        this._nearstNList = [])
    };
    return n.prototype._buildTree = function(e, n, a, o) {
        ...
        a > n && (l.left = this._buildTree(e, n, r - 1, o),
        l.right = this._buildTree(e, r + 1, a, o)),
        l
    }
    ,
    n.prototype.nearest = function(e, t) {
        var i = this.root
          ...
          , o = 1 / 0
          , r = null;
        for (i.data !== e && (o = t(i.data, e),
        r = i),
        e.array[i.axis] < i.data.array[i.axis] ? (i.right && (n[a++] = i.right),
        i.left && (n[a++] = i.left)) : (i.left && (n[a++] = i.left),
        i.right && (n[a++] = i.right)); a--; ) {
            i = n[a];
            ...
            r = i),
            h = !0),
            l ? (h && i.right && (n[a++] = i.right),
            i.left && (n[a++] = i.left)) : (h && i.left && (n[a++] = i.left),
            i.right && (n[a++] = i.right))
        }
        return r.data
    }
    ...
    n.prototype._addNearest = function(e, t, i) {
        for (var n = this._nearstNList, a = e - 1; a > 0 && !(t >= n[a - 1].dist); a--)
            n[a].dist = n[a - 1].dist,
            n[a].node = n[a - 1].node;
        n[a].dist = t,
        n[a].node = i
    ...
    n.prototype.nearestN = function(e, t, i, n) {
        if (0 >= t)
            return n.length = 0,
            n;
        for (var a = this.root, o = this._stack, r = 0, s = this._nearstNList, l = 0; t > l; l++)
            s[l] || (s[l] = {}),
            s[l].dist = 0,
            s[l].node = null;
        var h = i(a.data, e)
          , d = 0;
        for (a.data !== e && (d++,
        this._addNearest(d, h, a)),
        e.array[a.axis] < a.data.array[a.axis] ? (a.right && (o[r++] = a.right),
        a.left && (o[r++] = a.left)) : (a.left && (o[r++] = a.left),
        a.right && (o[r++] = a.right)); r--; ) {
            a = o[r];
            var h = e.array[a.axis] - a.data.array[a.axis]
              , c = 0 > h
              , m = !1;
            h *= h,
            (t > d || h < s[d - 1].dist) && (h = i(a.data, e),
            (t > d || h < s[d - 1].dist) && a.data !== e && (t > d && d++,
            this._addNearest(d, h, a)),
            m = !0),
            c ? (m && a.right && (o[r++] = a.right),
            a.left && (o[r++] = a.left)) : (m && a.left && (o[r++] = a.left),
            a.right && (o[r++] = a.right))
        }
        for (var l = 0; d > l; l++)
            n[l] = s[l].node.data;
...
define("echarts/data/quickSelect", ["require"], function() {
    ...
    function n(t, n, a, o, r) {
        return arguments.length <= 3 && (o = n,
        r = 2 == arguments.length ? e : a,
        n = 0,
        a = t.length - 1),
        i(t, n, a, o, r)
    }
...
define("echarts/component/dataView", ["require", "./base", "../config", "zrender/tool/util", "../component"], function(e) {
    ...
    return t.prototype = {
        ...
        show: function(e) {
            ...
            "function" != typeof i ? this._textArea.value = this._optionToContent() : (this._textArea = document.createElement("div"),
            ...
            this._buttonRefresh.innerHTML = t[2] || this._lang[2],
        ...
        _optionToContent: function() {
            ...
            if (this.option.xAxis)
                for (s = this.option.xAxis instanceof Array ? this.option.xAxis : [this.option.xAxis],
                e = 0,
                a = s.length; a > e; e++)
                    if ("category" == (s[e].type || "category")) {
                        for (r = [],
                        t = 0,
                        i = s[e].data.length; i > t; t++)
                            r.push(this.getDataFromOption(s[e].data[t]));
                        l += r.join(", ") + "\n\n"
                    }
            if (this.option.yAxis)
                for (s = this.option.yAxis instanceof Array ? this.option.yAxis : [this.option.yAxis],
                e = 0,
                a = s.length; a > e; e++)
        ...
        _contentToOption: function(e) {
            ...
            if (this.option.xAxis)
                for (h = this.option.xAxis instanceof Array ? this.option.xAxis : [this.option.xAxis],
                t = 0,
                o = h.length; o > t; t++)
                    if ("category" == (h[t].type || "category")) {
                        for (s = e[d].split(","),
                        i = 0,
                        a = h[t].data.length; a > i; i++)
                            l = this._trim(s[i] || ""),
                            r = h[t].data[i],
            ...
            if (this.option.yAxis)
                for (h = this.option.yAxis instanceof Array ? this.option.yAxis : [this.option.yAxis],
                t = 0,
                o = h.length; o > t; t++)
            ...
            o = c.length; o > t; t++)
                if (d++,
                c[t].type == n.CHART_TYPE_SCATTER)
                    for (var i = 0, a = c[t].data.length; a > i; i++)
                        s = e[d],
                        l = s.replace(" ", "").split(","),
...
define("zrender/shape/Sector", ["require", "../tool/math", "../tool/computeBoundingBox", "../tool/vector", "./Base", "../tool/util"], function(e) {
    ...
    return h.prototype = {
        ...
        getRect: function(e) {
            ...
            return u || (m = -m,
            p = -p),
            d > 1 ? i.arc(a, h, d, m, p, !u, o, s) : (o[0] = s[0] = a,
            o[1] = s[1] = h),
...
define("zrender/tool/computeBoundingBox", ["require", "./vector", "./curve"], function(e) {
    ...
    function i(e, t, i, n, a, r) {
        ...
        for (var l = 0; l < s.length; l++)
            s[l] = o.cubicAt(e[0], t[0], i[0], n[0], s[l]);
        var h = [];
        o.cubicExtrema(e[1], t[1], i[1], n[1], h);
        for (var l = 0; l < h.length; l++)
            h[l] = o.cubicAt(e[1], t[1], i[1], n[1], h[l]);
        s.push(e[0], n[0]),
        h.push(e[1], n[1]);
    ...
    var a = e("./vector")
      ...
      , h = function(e, t, i, n, o, h, d, c) {
        if (Math.abs(n - o) >= 2 * Math.PI)
            return d[0] = e - i,
            d[1] = t - i,
            c[0] = e + i,
            void (c[1] = t + i);
        if (r[0] = Math.cos(n) * i + e,
        r[1] = Math.sin(n) * i + t,
        s[0] = Math.cos(o) * i + e,
        s[1] = Math.sin(o) * i + t,
        a.min(d, r, s),
        ...
        o %= 2 * Math.PI,
        0 > o && (o += 2 * Math.PI),
        n > o && !h ? o += 2 * Math.PI : o > n && h && (n += 2 * Math.PI),
        h) {
            var m = o;
            o = n,
            n = m
    ...
    return t.prototype = {
        ...
        brushSymbol: function(e, t) {
            ...
            for (var a, o = t.chainPoint, r = 0, s = o.length; s > r; r++) {
                ...
                e.restore()) : e.fillText(a.name, a.textX, a.textY))
            }
            e.restore()
        },
    ...
    return t.prototype = {
        ...
        axisBase: {
            _buildAxisLine: function() {
                ...
                var o = i.style;
                "" !== this.option.name && (o.text = this.option.name,
                o.textPosition = this.option.nameLocation,
                o.textFont = this.getFont(this.option.nameTextStyle),
                this.option.nameTextStyle.align && (o.textAlign = this.option.nameTextStyle.align),
                this.option.nameTextStyle.baseline && (o.textBaseline = this.option.nameTextStyle.baseline),
                this.option.nameTextStyle.color && (o.textColor = this.option.nameTextStyle.color)),
            ...
            _axisLabelClickable: function(e, t) {
                return e ? (o.pack(t, void 0, -1, void 0, -1, t.style.text),
                t.hoverable = !0,
                t.clickable = !0,
                t.highlightStyle = {
                ...
                if (this.option.axisLine.onZero) {
                    ...
                    if (this.isHorizontal() && null != t)
                        for (var n = 0, a = this.shapeList.length; a > n; n++)
                            "axisLine" === this.shapeList[n]._axisShape ? (this.shapeList[n].style.yStart = this.shapeList[n].style.yEnd = this.subPixelOptimize(t, this.shapeList[n].stylelineWidth),
                            this.zr.modShape(this.shapeList[n].id)) : "axisTick" === this.shapeList[n]._axisShape && (i = this.shapeList[n].style.yEnd - this.shapeList[n].style.yStart,
                            this.shapeList[n].style.yStart = t - i,
                            this.shapeList[n].style.yEnd = t,
                            this.zr.modShape(this.shapeList[n].id));
                    if (!this.isHorizontal() && null != e)
                        for (var n = 0, a = this.shapeList.length; a > n; n++)
                            "axisLine" === this.shapeList[n]._axisShape ? (this.shapeList[n].style.xStart = this.shapeList[n].style.xEnd = this.subPixelOptimize(e, this.shapeList[n].stylelineWidth),
                            this.zr.modShape(this.shapeList[n].id)) : "axisTick" === this.shapeList[n]._axisShape && (i = this.shapeList[n].style.xEnd - this.shapeList[n].style.xStart,
                            this.shapeList[n].style.xStart = e,
                            this.shapeList[n].style.xEnd = e + i,
                            this.zr.modShape(this.shapeList[n].id))
                }
            },
        ...
        reformOption: function(e) {
            ...
            "xAxis" === this.axisType) {
                (!e[0].position || "bottom" != e[0].position && "top" != e[0].position) && (e[0].position = "bottom"),
                ...
                (!e[0].position || "left" != e[0].position && "right" != e[0].position) && (e[0].position = "left"),
        ...
        refresh: function(t) {
            var i;
            t && (this.option = t,
            "xAxis" === this.axisType ? (this.option.xAxis = this.reformOption(t.xAxis),
            i = this.option.xAxis) : (this.option.yAxis = this.reformOption(t.yAxis),
            i = this.option.yAxis),
            this.series = t.series);
            for (var n = e("./categoryAxis"), a = e("./valueAxis"), o = Math.max(i && i.length || 0, this._axisList.length), r = 0; o > r; r++)
                !this._axisList[r] || !t || i[r] && this._axisList[r].type == i[r].type || (this._axisList[r].dispose && this._axisList[r].dispose(),
                this._axisList[r] = !1),
...
define("echarts/component/grid", ["require", "./base", "zrender/shape/Rectangle", "../config", "zrender/tool/util", "../component"], function(e) {
    ...
    return t.prototype = {
        ...
        refixAxisShape: function(e) {
            for (var t, i, n, o = e.xAxis._axisList.concat(e.yAxis ? e.yAxis._axisList : []), r = o.length; r--; )
                n = o[r],
...
define("echarts/component/dataZoom", ["require", "./base", "zrender/shape/Rectangle", "zrender/shape/Polygon", "../util/shape/Icon", "../config", "../util/date", "zrender/tool/util", "../component"], function(e) {
    ...
    return t.prototype = {
        ...
        _getLocation: function() {
            ...
            return "horizontal" == this.zoomOption.orient ? (i = this.zoomOption.width || a.getWidth(),
            n = this.zoomOption.height || this._fillerSize,
            e = null != this.zoomOption.x ? this.zoomOption.x : a.getX(),
            t = null != this.zoomOption.y ? this.zoomOption.y : this.zr.getHeight() - n - 2) : (i = this.zoomOption.width || this._fillerSize,
            n = this.zoomOption.height || a.getHeight(),
            e = null != this.zoomOption.x ? this.zoomOption.x : 2,
            t = null != this.zoomOption.y ? this.zoomOption.y : a.getY()),
            {
                x: e,
                y: t,
                width: i,
        ...
        _getZoom: function() {
            ...
            if (t && null == s) {
                ...
                for (var l = 0, h = t.length; h > l; l++)
                    ("category" == t[l].type || null == t[l].type) && n.push(l)
            } else
                n = s instanceof Array ? s : null != s ? [s] : [];
            if (s = this.zoomOption.yAxisIndex,
            i && null == s) {
                a = [];
                for (var l = 0, h = i.length; h > l; l++)
                    "category" == i[l].type && a.push(l)
            } else
                a = s instanceof Array ? s : null != s ? [s] : [];
            for (var d, l = 0, h = e.length; h > l; l++)
                if (d = e[l],
                d.type == r.CHART_TYPE_LINE || d.type == r.CHART_TYPE_BAR || d.type == r.CHART_TYPE_SCATTER || d.type == r.CHART_TYPE_K) {
                    for (var c = 0, m = n.length; m > c; c++)
        ...
        _backupData: function() {
            ...
            for (var e = this.option.xAxis, t = this._zoom.xAxisIndex, i = 0, n = t.length; n > i; i++)
                this._originalData.xAxis[t[i]] = e[t[i]].data;
            for (var a = this.option.yAxis, o = this._zoom.yAxisIndex, i = 0, n = o.length; n > i; i++)
                this._originalData.yAxis[o[i]] = a[o[i]].data;
            for (var s, l = this.option.series, h = this._zoom.seriesIndex, i = 0, n = h.length; n > i; i++)
                s = l[h[i]],
                this._originalData.series[h[i]] = s.data,
                s.data && this.getDataFromOption(s.data[0])instanceof Array && (s.type == r.CHART_TYPE_SCATTER || s.type == r.CHART_TYPE_LINE || s.type == r.CHART_TYPE_BAR) && (this._backupScale(),
                this._calculScatterMap(h[i]))
        },
        ...
        _buildBackground: function() {
            ...
            for (var i = 0, o = this._originalData.xAxis, s = this._zoom.xAxisIndex, l = 0, h = s.length; h > l; l++)
                i = Math.max(i, o[s[l]].length);
            for (var d = this._originalData.yAxis, c = this._zoom.yAxisIndex, l = 0, h = c.length; h > l; l++)
                i = Math.max(i, d[c[l]].length);
            for (var m, p = this._zoom.seriesIndex[0], u = this._originalData.series[p], V = Number.MIN_VALUE, U = Number.MAX_VALUE, l = 0, h = u.length; h > l; l++)
                m = this.getDataFromOption(u[l], 0),
            ...
            "horizontal" == this.zoomOption.orient ? (f.push([this._location.x + e, this._location.y + t]),
            f.push([this._location.x, this._location.y + t])) : (f.push([this._location.x, this._location.y]),
            f.push([this._location.x, this._location.y + t])),
            this.shapeList.push(new a({
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
        ...
        _syncFillerShape: function() {
            var e, t;
            "horizontal" == this.zoomOption.orient ? (e = this._startShape.style.x,
            t = this._endShape.style.x,
            this._fillerShae.style.x = Math.min(e, t) + this._handleSize,
            this._fillerShae.style.width = Math.abs(e - t) - this._handleSize,
            this._zoom.start = (Math.min(e, t) - this._location.x) / this._location.width * 100,
            this._zoom.end = (Math.max(e, t) + this._handleSize - this._location.x) / this._location.width * 100) : (e = this._startShape.style.y,
            t = this._endShape.style.y,
            this._fillerShae.style.y = Math.min(e, t) + this._handleSize,
            this._fillerShae.style.height = Math.abs(e - t) - this._handleSize,
            this._zoom.start = (this._location.y + this._location.height - Math.max(e, t)) / this._location.height * 100,
            this._zoom.end = (this._location.y + this._location.height - Math.min(e, t) - this._handleSize) / this._location.height * 100),
        ...
        _syncData: function(e) {
            ...
            for (var s in this._originalData) {
                ...
                for (var l in t)
                    o = t[l],
                    null != o && (a = o.length,
                    i = Math.floor(this._zoom.start / 100 * a),
                    n = Math.ceil(this._zoom.end / 100 * a),
                    this.getDataFromOption(o[0])instanceof Array && this.option[s][l].type != r.CHART_TYPE_K ? (this._setScale(),
                    this.option[s][l].data = this._synScatterData(l, o)) : this.option[s][l].data = o.slice(i, n))
            }
        ...
        _synScatterData: function(e, t) {
            ...
            "horizontal" == this.zoomOption.orient ? (i = l.x.max - l.x.min,
            n = this._zoom.start / 100 * i + l.x.min,
            a = this._zoom.end / 100 * i + l.x.min,
            i = l.y.max - l.y.min,
            o = this._zoom.start2 / 100 * i + l.y.min,
            r = this._zoom.end2 / 100 * i + l.y.min) : (i = l.x.max - l.x.min,
            n = this._zoom.start2 / 100 * i + l.x.min,
            a = this._zoom.end2 / 100 * i + l.x.min,
            i = l.y.max - l.y.min,
            o = this._zoom.start / 100 * i + l.y.min,
            r = this._zoom.end / 100 * i + l.y.min);
            var h;
            (h = l.x.dataMappingMethods) && (n = h.coord2Value(n),
            a = h.coord2Value(a)),
            (h = l.y.dataMappingMethods) && (o = h.coord2Value(o),
            r = h.coord2Value(r));
            for (var d, c = 0, m = t.length; m > c; c++)
                d = t[c].value || t[c],
        ...
        _setScale: function() {
            ...
            for (var i in t)
                for (var n = 0, a = t[i].length; a > n; n++)
                    t[i][n].scale = e || t[i][n]._scale
        },
        _backupScale: function() {
            ...
            for (var t in e)
                for (var i = 0, n = e[t].length; n > i; i++)
                    e[t][i]._scale = e[t][i].scale
        },
        _getDetail: function() {
        ...
        __ondrift: function(e, t, i) {
            ...
            if ("horizontal" == this.zoomOption.orient ? e.style.x + t - n <= this._location.x ? e.style.x = this._location.x + n : e.style.x + t + e.style.width + n >= this._location.x + this._location.width ? e.style.x = this._location.x + this._location.width - e.style.width - n : e.style.x += t : e.style.y + i - n <= this._location.y ? e.style.y = this._location.y + n : e.style.y + i + e.style.height + n >= this._location.y + this._location.height ? e.style.y = this._location.y + this._location.height - e.style.height - n : e.style.y += i,
            "filler" == e._type ? this._syncHandleShape() : this._syncFillerShape(),
        ...
        ondragend: function(e, t) {
            this.isDragend && e.target && (!this.zoomOption.realtime && this._syncData(),
            t.dragOut = !0,
            t.dragIn = !0,
            this._isSilence || this.zoomOption.realtime || this.messageCenter.dispatch(r.EVENT.DATA_ZOOM, null, {
                zoom: this._zoom
            }, this.myChart),
            t.needRefresh = !1,
            this.isDragend = !1)
        ...
        rectZoom: function(e) {
            ...
            if (i.width < 0 && (i.x += i.width,
            i.width = -i.width),
            i.height < 0 && (i.y += i.height,
            i.height = -i.height),
            ...
            return "horizontal" == this.zoomOption.orient ? (n = this._zoom.end - this._zoom.start,
            this._zoom.start += n * a,
            this._zoom.end -= n * o,
            n = this._zoom.end2 - this._zoom.start2,
            this._zoom.start2 += n * r,
            this._zoom.end2 -= n * s) : (n = this._zoom.end - this._zoom.start,
            this._zoom.start += n * r,
            this._zoom.end -= n * s,
            n = this._zoom.end2 - this._zoom.start2,
            this._zoom.start2 += n * a,
            this._zoom.end2 -= n * o),
            this._syncShape(),
            this._syncData(!0),
            this._zoom
...
define("echarts/component/categoryAxis", ["require", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "../config", "zrender/tool/util", "zrender/tool/area", "../component"], function(e) {
    ...
    return t.prototype = {
        ...
        _getInterval: function() {
            ...
            if ("auto" == e) {
                ...
                if (this.isHorizontal())
                        ...
                        e = Math.floor(15 / r); !h && n > e; ) {
                            ...
                            for (var c = Math.floor((n - 1) / e) * e; c >= 0; c -= e) {
                                if (0 !== this.option.axisLabel.rotate)
                                    ...
                                    o = l.getTextWidth(this._getReformedLabel(c), this.getFont(s.merge(i[c].textStyle, this.option.axisLabel.textStyle)));
                                else {
                    ...
                    var r = this.getGap();
                    for (e = Math.floor(11 / r); t > r * e - 6 && n > e; )
                        e++
                } else
                    e = 1
            } else
                e = "function" == typeof e ? 1 : e - 0 + 1;
            return e
        },
        _buildShape: function() {
        ...
        _buildAxisTick: function() {
            var e, t = this.option.data, i = this.option.data.length, n = this.option.axisTick, o = n.length, r = n.lineStyle.color, s = n.lineStyle.width, l = "function" == typeof n.interval ? n.interval : "auto" == n.interval && "function" == typeof this.option.axisLabel.interval ? this.option.axisLabel.interval : !1, h = l ? 1 : "auto" == n.interval ? this._interval : n.interval - 0 + 1, d = n.onGap, c = d ? this.getGap() / 2 : "undefined" == typeof d && this.option.boundaryGap ? this.getGap() / 2 : 0, m = c > 0 ? -h : 0;
            if (this.isHorizontal())
                for (var p, u = "bottom" == this.option.position ? n.inside ? this.grid.getYend() - o - 1 : this.grid.getYend() + 1 : n.inside ? this.grid.getY() + 1 : this.grid.getY() - o - 1, V = m; i > V; V += h)
                    (!l || l(V, t[V])) && (p = this.subPixelOptimize(this.getCoordByIndex(V) + (V >= 0 ? c : 0), s),
                    e = {
                        _axisShape: "axisTick",
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                ...
                for (var U, g = "left" == this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, V = m; i > V; V += h)
                    (!l || l(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - (V >= 0 ? c : 0), s),
                    e = {
                        _axisShape: "axisTick",
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
        ...
        _buildAxisLabel: function() {
            var e, t, i = this.option.data, a = this.option.data.length, o = this.option.axisLabel, r = o.rotate, l = o.margin, h = o.clickable, d = o.textStyle, c = "function" == typeof o.interval ? o.interval : !1;
            if (this.isHorizontal()) {
                var m, p;
                "bottom" == this.option.position ? (m = this.grid.getYend() + l,
                p = "top") : (m = this.grid.getY() - l,
                p = "bottom");
                for (var u = 0; a > u; u += this._interval)
                    c && !c(u, i[u]) || "" === this._getReformedLabel(u) || (t = s.merge(i[u].textStyle || {}, d),
                    e = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase() + 3,
                        hoverable: !1,
                    ...
                    r && (e.style.textAlign = r > 0 ? "bottom" == this.option.position ? "right" : "left" : "bottom" == this.option.position ? "left" : "right",
                    e.rotation = [r * Math.PI / 180, e.style.x, e.style.y]),
                    this.shapeList.push(new n(this._axisLabelClickable(h, e))))
            } else {
                var V, U;
                "left" == this.option.position ? (V = this.grid.getX() - l,
                U = "right") : (V = this.grid.getXend() + l,
                U = "left");
                for (var u = 0; a > u; u += this._interval)
                    c && !c(u, i[u]) || "" === this._getReformedLabel(u) || (t = s.merge(i[u].textStyle || {}, d),
                    e = {
                    ...
                    r && (e.rotation = [r * Math.PI / 180, e.style.x, e.style.y]),
                    this.shapeList.push(new n(this._axisLabelClickable(h, e))))
            }
        },
        _buildSplitLine: function() {
            var e, t = this.option.data, i = this.option.data.length, n = this.option.splitLine, o = n.lineStyle.type, r = n.lineStyle.width, s = n.lineStyle.color;
            ...
            if (i -= d || "undefined" == typeof d && this.option.boundaryGap ? 1 : 0,
            this.isHorizontal())
                for (var m, p = this.grid.getY(), u = this.grid.getYend(), V = 0; i > V; V += this._interval)
                    (!h || h(V, t[V])) && (m = this.subPixelOptimize(this.getCoordByIndex(V) + c, r),
                    e = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                ...
                for (var U, g = this.grid.getX(), f = this.grid.getXend(), V = 0; i > V; V += this._interval)
                    (!h || h(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - c, r),
                    e = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
        ...
        _buildSplitArea: function() {
            var e, t = this.option.data, i = this.option.splitArea, n = i.areaStyle.color;
            if (n instanceof Array) {
                var a = n.length
                ...
                if (this.isHorizontal())
                    for (var d, c = this.grid.getY(), m = this.grid.getHeight(), p = this.grid.getX(), u = 0; r >= u; u += this._interval)
                        s && !s(u, t[u]) && r > u || (d = r > u ? this.getCoordByIndex(u) + h : this.grid.getXend(),
                        e = {
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            hoverable: !1,
                    ...
                    for (var V, U = this.grid.getX(), g = this.grid.getWidth(), f = this.grid.getYend(), u = 0; r >= u; u += this._interval)
                        s && !s(u, t[u]) && r > u || (V = r > u ? this.getCoordByIndex(u) - h : this.grid.getY(),
                        e = {
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            hoverable: !1,
        ...
        refresh: function(e) {
            e && (this.option = this.reformOption(e),
        ...
        getCoord: function(e) {
            for (var t = this.option.data, i = t.length, n = this.getGap(), a = this.option.boundaryGap ? n / 2 : 0, o = 0; i > o; o++) {
                if (this.getDataFromOption(t[o]) == e)
                    return a = this.isHorizontal() ? this.grid.getX() + a : this.grid.getYend() - a;
                a += n
            }
        },
        ...
        getIndexByName: function(e) {
            for (var t = this.option.data, i = t.length, n = 0; i > n; n++)
                if (this.getDataFromOption(t[n]) == e)
                    return n;
            return -1
        },
...
define("echarts/component/valueAxis", ["require", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "../config", "../util/date", "zrender/tool/util", "../util/smartSteps", "../util/accMath", "../util/smartLogSteps", "../component"], function(e) {
    ...
    return t.prototype = {
        ...
        _buildAxisTick: function() {
            ...
            if (this.isHorizontal())
                for (var l, h = "bottom" === this.option.position ? n.inside ? this.grid.getYend() - o - 1 : this.grid.getYend() + 1 : n.inside ? this.grid.getY() + 1 : this.grid.getY() - o - 1, d = 0; i > d; d++)
                    l = this.subPixelOptimize(this.getCoord(t[d]), s),
                    e = {
                        _axisShape: "axisTick",
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                ...
                for (var c, m = "left" === this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, d = 0; i > d; d++)
                    c = this.subPixelOptimize(this.getCoord(t[d]), s),
                    e = {
                        _axisShape: "axisTick",
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
        ...
        _buildAxisLabel: function() {
            ...
            if (this.isHorizontal()) {
                var l, h;
                "bottom" === this.option.position ? (l = this.grid.getYend() + o,
                h = "top") : (l = this.grid.getY() - o,
                h = "bottom");
                for (var d = 0; i > d; d++)
                    e = {
                        zlevel: this.getZlevelBase(),
                    ...
                    a && (e.style.textAlign = a > 0 ? "bottom" === this.option.position ? "right" : "left" : "bottom" === this.option.position ? "left" : "right",
                    e.rotation = [a * Math.PI / 180, e.style.x, e.style.y]),
                    this.shapeList.push(new n(this._axisLabelClickable(r, e)))
            } else {
                var c, m;
                "left" === this.option.position ? (c = this.grid.getX() - o,
                m = "right") : (c = this.grid.getXend() + o,
                m = "left");
                for (var d = 0; i > d; d++)
                    e = {
                        zlevel: this.getZlevelBase(),
        ...
        _buildSplitLine: function() {
            ...
            var l = s.length;
            if (this.isHorizontal())
                for (var h, d = this.grid.getY(), c = this.grid.getYend(), m = 0; i > m; m++)
                    h = this.subPixelOptimize(this.getCoord(t[m]), r),
                    e = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                ...
                for (var p, u = this.grid.getX(), V = this.grid.getXend(), m = 0; i > m; m++)
                    p = this.subPixelOptimize(this.getCoord(t[m]), r),
                    e = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
        ...
        _buildSplitArea: function() {
            ...
            if (t instanceof Array) {
                ...
                if (this.isHorizontal())
                    for (var r, s = this.grid.getY(), l = this.grid.getHeight(), h = this.grid.getX(), d = 0; a >= d; d++)
                        r = a > d ? this.getCoord(n[d]) : this.grid.getXend(),
                        e = {
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            hoverable: !1,
                    ...
                    for (var c, m = this.grid.getX(), p = this.grid.getWidth(), u = this.grid.getYend(), d = 0; a >= d; d++)
                        c = a > d ? this.getCoord(n[d]) : this.grid.getY(),
                        e = {
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            hoverable: !1,
        ...
        _calculateValue: function() {
            if (isNaN(this.option.min - 0) || isNaN(this.option.max - 0)) {
                for (var e, t, i = {}, n = this.component.legend, a = 0, o = this.series.length; o > a; a++)
                    !(this.series[a].type != r.CHART_TYPE_LINE && this.series[a].type != r.CHART_TYPE_BAR && this.series[a].type != r.CHART_TYPE_SCATTER && this.series[a].type != r.CHART_TYPE_K && this.series[a].type != r.CHART_TYPE_EVENTRIVER || n && !n.isSelected(this.series[a].name) || (e = this.series[a].xAxisIndex || 0,
                    t = this.series[a].yAxisIndex || 0,
                    this.option.xAxisIndex != e && this.option.yAxisIndex != t || !this._calculSum(i, a)));
                var s;
                for (var a in i) {
                    s = i[a];
                ...
                for (var a in i) {
                    s = i[a];
                    for (var l = 0, h = s.length; h > l; l++)
                        isNaN(s[l]) || (this._min = Math.min(this._min, s[l]),
                        this._max = Math.max(this._max, s[l]))
                }
        ...
        _calculSum: function(e, t) {
            ...
            if (this.series[t].stack) {
                ...
                for (var h = 0, d = n.length; d > h; h++)
                    i = this.getDataFromOption(n[h]),
                    "-" !== i && (i -= 0,
                    i >= 0 ? null != e[o][h] ? e[o][h] += i : e[o][h] = i : null != e[l][h] ? e[l][h] += i : e[l][h] = i,
                    this.option.scale && e[a].push(i))
            } else if (e[a] = e[a] || [],
            this.series[t].type != r.CHART_TYPE_EVENTRIVER) {
                n = this.series[t].data;
                for (var h = 0, d = n.length; d > h; h++)
                    i = this.getDataFromOption(n[h]),
                    this.series[t].type === r.CHART_TYPE_K ? (e[a].push(i[0]),
                    e[a].push(i[1]),
                    e[a].push(i[2]),
                    e[a].push(i[3])) : i instanceof Array ? (-1 != this.option.xAxisIndex && e[a].push("time" != this.option.type ? i[0] : s.getNewDate(i[0])),
                    -1 != this.option.yAxisIndex && e[a].push("time" != this.option.type ? i[1] : s.getNewDate(i[1]))) : e[a].push(i)
            } else {
                n = this.series[t].data;
                for (var h = 0, d = n.length; d > h; h++)
                    for (var c = n[h].evolution, m = 0, p = c.length; p > m; m++)
                        e[a].push(s.getNewDate(c[m].time))
            }
        },
        ...
        _reformTimeValue: function() {
            ...
            case "year":
                ...
                break;
            default:
                72e5 >= n ? a = (Math.floor(this._min / n) + 1) * n : (a = s.getNewDate(this._min - -n),
                a.setHours(6 * Math.round(a.getHours() / 6)),
                a.setMinutes(0),
                a.setSeconds(0))
            }
            for (a - this._min < n / 2 && (a -= -n),
            t = s.getNewDate(a),
            e *= 1.5; e-- >= 0 && (("month" == i || "quarter" == i || "half-year" == i || "year" == i) && t.setDate(1),
            !(this._max - t < n / 2)); )
                this._valueList.push(t),
                t = s.getNewDate(t - -n);
        ...
        _customerValue: function() {
            ...
            this._valueList = [];
            for (var a = 0; i >= a; a++)
                this._valueList.push(t.accAdd(this._min, t.accMul(n, a)));
            this._reformLabelData()
        },
        ...
        _reformLabelData: function(e) {
            ...
            if (t)
                for (var i = 0, n = this._valueList.length; n > i; i++)
                    "function" == typeof t ? this._valueLabel.push(e ? t.call(this.myChart, this._valueList[i], e) : t.call(this.myChart, this._valueList[i])) : "string" == typeof t && this._valueLabel.push(e ? s.format(t, this._valueList[i]) : t.replace("{value}", this._valueList[i]));
            else
                for (var i = 0, n = this._valueList.length; n > i; i++)
                    this._valueLabel.push(e ? e(this._valueList[i]) : this.numAddCommas(this._valueList[i]))
        },
        ...
        refresh: function(e, t) {
            e && (this.option = this.reformOption(e),
            this.option.axisLabel.textStyle = l.merge(this.option.axisLabel.textStyle || {}, this.ecTheme.textStyle),
            this.series = t),
            this.zr && (this.clear(),
            this._buildShape())
        },
        ...
        getValueFromCoord: function(e) {
            var t;
            return this.isHorizontal() ? (e = e < this.grid.getX() ? this.grid.getX() : e,
            e = e > this.grid.getXend() ? this.grid.getXend() : e,
            t = this._min + (e - this.grid.getX()) / this.grid.getWidth() * (this._max - this._min)) : (e = e < this.grid.getY() ? this.grid.getY() : e,
            e = e > this.grid.getYend() ? this.grid.getYend() : e,
            t = this._max - (e - this.grid.getY()) / this.grid.getHeight() * (this._max - this._min)),
...
define("echarts/util/date", [], function() {
    function e(e, t, i) {
        ...
        for (var n, a, o, r, s = 0, l = d.length; l > s; s++)
            if (n = d[s].value,
            a = Math.ceil(t / n) * n - Math.floor(e / n) * n,
            Math.round(a / n) <= 1.2 * i) {
                o = d[s].formatter,
                r = d[s].value;
                break
            }
        return null == o && (o = "year",
        n = 317088e5,
        a = Math.ceil(t / n) * n - Math.floor(e / n) * n,
        r = Math.round(a / (i - 1) / n) * n),
        {
            formatter: o,
            gapValue: r
        }
...
define("echarts/util/smartSteps", [], function() {
    ...
    function a(e, i, n, a) {
        ...
        e = l.c,
        i = h.c;
        for (var c = (i - e) / n, m = t(a), p = 0, u = [], V = n + 1; V--; )
            u[V] = (e + c * V) * m;
        if (0 > a) {
            p = U(m),
            c = +(c * m).toFixed(p),
    ...
    function o(n, a, o) {
        a = W(a % 10) || 2,
        0 > a && (i(n) ? a = ("" + S(n)).replace(/0+$/, "").length || 1 : (n = n.toFixed(15).replace(/0+$/, ""),
        a = n.replace(".", "").replace(/^[-0]+/, "").length,
        n = +n));
        var r = X(e(n)) - a + 1
    ...
    function h(e, t, n) {
        var s, h = n || +_.slice(-1), u = l((t - e) / h, b), U = o(t - e), f = o(e, -1, 1), y = o(t, -1);
        if (r(U, u),
        r(f, u, 1),
        r(y, u),
        n ? s = c(f, y, h) : h = d(f, y),
    ...
    function d(e, i) {
        for (var n, a, o, r, s = [], h = _.length; h--; )
            n = _[h],
            a = l((i.c - e.c) / n, b),
            a = a.c * t(a.e),
            o = X(e.c / a) * a,
    ...
    function c(e, i, n) {
        for (var a, o, r = i.c, s = (i.c - e.c) / n - 1; r > e.c; )
            s = l(s + 1, b),
            s = s.c * t(s.e),
            a = s * n,
            o = I(i.c / s) * s,
    ...
    function f(e, t, i) {
        ...
        S(t / s) < 1e-6 && (t = 0),
        S(e / s) < 1e-6 && (e = 0);
        var l, h, d, c = [[5, 10], [10, 2], [50, 10], [100, 2]], m = [], p = [], u = o(t - e, 3), V = o(e, -1, 1), U = o(t, -1);
        r(V, u, 1),
        r(U, u),
        s = U.c - V.c,
        u.c = s;
    ...
    var y, b, _, x, k, v = [10, 20, 25, 50], L = [4, 5, 6], w = Math, W = w.round, X = w.floor, I = w.ceil, S = w.abs;
    return n
}),
define("echarts/util/smartLogSteps", ["require", "./number"], function(e) {
    ...
    function a() {
        function e() {
            ...
            c(a - r) && (a -= 1),
            f = -a * V;
            for (var s = a; o >= s - e; s += e)
                _.push(L(p, s))
        }
        function t() {
            for (var e = i(h, 0), t = e + 2; t > e && a(e + 1) + n(e + 1) * C < r; )
                e++;
            for (var l = i(s, 0), t = l - 2; l > t && a(l - 1) + n(l - 1) * C > o; )
                l--;
            f = -(a(e) * S + n(e) * K);
            for (var d = e; l >= d; d++) {
                var c = a(d)
    ...
    function o() {
        for (var e = [], t = 0, i = _.length; i > t; t++)
            e[t] = (m ? 1 : -1) * _[t];
        !m && e.reverse();
        var n = s()
          , a = n.value2Coord
    ...
    function s() {
        ...
        return {
            value2Coord: function(i) {
                return null == i || isNaN(i) || !isFinite(i) ? i : (i = parseFloat(i),
                isFinite(i) ? e && T > i ? i = T : !e && i > -T && (i = -T) : i = T,
                i = w(i),
                (e ? 1 : -1) * (v(i) + t))
            },
    ...
    var m, p, u, V, U, g, f, y, b, _, x = e("./number"), k = Math, v = k.log, L = k.pow, w = k.abs, W = k.ceil, X = k.floor, I = k.E, S = k.LN10, K = k.LN2, C = K / S, T = 1e-9, E = 5, z = 2, A = {
        0: "⁰",
        1: "¹",
        2: "²",
        3: "³",
